...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input type="text" class="number_range_filter" placeholder="From"  id="' + sFromId + '" rel="' + i + '"/>');
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $(' <input type="text" class="number_range_filter" placeholder="To" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
        ...
        function fnCreateDateRangeInput(oTable) {
            th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" class="date_range_filter " placeholder="From" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker({
                changeMonth: true,
                changeYear: true,
                showWeek: true,
            ...
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="date_range_filter " placeholder="To" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
            th.append(_fnRangeLabelPart(2));
                ...
                onClose: function () {
                    ...
                    if (dt1 != null) {
                        if (dt2 <= dt1) {
                            ...
                            ShowResult("Fail", "Date Must be greater than FromDate ");
                        }
                    }
        ...
        function fnCreateCheckbox(oTable, aData) {
            ...
            fnOnFiltered = function () {
                var target = $('#' + buttonId);
                $('#' + checkToggleDiv).dialog("widget").position({ my: 'bottom',
                    at: 'top',
                    of: target
                });
                fnOnFilteredCurrent();
