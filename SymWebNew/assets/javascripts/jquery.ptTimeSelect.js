            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                        ...
                        +    '                    <div class="ptTimeSelectLeftPane" style="width: 100%; text-align: center; float: left;" class="">Hour</div>'
                        +    '                </div>'
                        +    '                <div>'
                        ...
                        +    '                                        style="display: block; width: 48%; float: left;">AM</a>'
                        +    '                                <a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);" '
                        +    '                                        style="display: block; width: 48%; float: left;">PM</a>'
                        ...
                        +    '                        </div>'
                        + '                    </div>'
                        + '                    <div class="ptTimeSelectRightPane" style="width: 100%; text-align: center; float: left;">Minutes</div>'
