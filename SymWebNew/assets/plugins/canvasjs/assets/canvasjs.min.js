...
(function() {
    ...
    function Qa(a) {
        a.roundRect = function(a, b, c, f, g, h, k, l) {
            k && (this.fillStyle = k);
    ...
    function sa(a, d, b) {
        if (v && Na) {
            ...
            ta = c.webkitBackingStorePixelRatio || c.mozBackingStorePixelRatio || c.msBackingStorePixelRatio || c.oBackingStorePixelRatio || c.backingStorePixelRatio || 1;
            Q = Aa / ta;
            a.width = d * Q;
            a.height = b * Q;
            Aa !== ta && (a.style.width = d + "px", a.style.height = b + "px", c.scale(Q, Q))
    ...
    function Sa(a) {
        if (!Ba) {
            var d = !1,
                b = !1;
            "undefined" === typeof ba.Chart.creditHref ? (a.creditHref = "Symphonysoftt.com",
                a.creditText = "Symphonysoftt.com") : (d = a.updateOption("creditText"), b = a.updateOption("creditHref"));
    ...
    function A(a, d) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Qa(this.ctx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = fa(c, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
    ...
    function va(a, d) {
        for (var b = [], c, f = 0; f < a.length; f++)
            if (0 == f) b.push(a[0]);
                ...
                g = 0 === k ? 0 : k - 1;
                h = k === a.length - 1 ? k : k + 1;
                c = Math.abs((a[h].x - a[g].x) / (0 === a[k].x - a[g].x ? 0.01 : a[k].x - a[g].x)) * (d - 1) / 2 + 1;
                l = (a[h].x - a[g].x) / c;
                c = (a[h].y - a[g].y) / c;
                b[b.length] = a[k].x > a[g].x && 0 < l || a[k].x < a[g].x && 0 > l ? {
                    x: a[k].x - l / 3,
    ...
    function na(a, d) {
        na.base.constructor.call(this, "Title", d, a.theme, a);
        this.chart = a;
    ...
    function wa(a, d) {
        wa.base.constructor.call(this, "Subtitle", d, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function xa(a, d) {
        xa.base.constructor.call(this, "Legend", d, a.theme, a);
        this.chart =
            a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function B(a, d, b, c, f) {
        ...
        if (this.options.stripLines && 0 < this.options.stripLines.length)
            for (this.stripLines = [], d = 0; d < this.options.stripLines.length; d++) this.stripLines.push(new oa(this.chart, this.options.stripLines[d], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    function oa(a, d, b, c, f) {
        oa.base.constructor.call(this, "StripLine", d, b, f);
        this.id = c;
        this.chart = a;
        this.ctx = this.chart.ctx;
    ...
    function pa(a) {
        var d;
        a && qa[a] && (d = qa[a]);
        pa.base.constructor.call(this, "CultureInfo", d)
    }
    ...
    var z = {},
        ...
        Fa = function() {
            ...
            return function(k, l, m) {
                ...
                "UTC:" === l.slice(0, 4) && (l = l.slice(4), q = !0);
                m = q ? "getUTC" : "get";
                var s = k[m + "Date"](),
                    u = k[m + "Day"](),
                    w = k[m + "Month"](),
                ...
                return m = l.replace(a, function(a) {
                    switch (a) {
                        ...
                        case "ss":
                            return O(Z, 2);
                        case "f":
                            return String(ja).slice(0, 1);
                        case "ff":
                            return O(String(ja).slice(0, 2), 2);
                        case "fff":
                            return O(String(ja).slice(0, 3), 3);
                        case "t":
                            return 12 > t ? "a" : "p";
                        case "tt":
                            return 12 > t ? "am" : "pm";
                        ...
                        case "TT":
                            return 12 > t ? "AM" : "PM";
                        case "K":
                            return q ? "UTC" : (String(k).match(g) || [""]).pop().replace(h, "");
                        case "z":
        ...
        ca = function(a, d, b) {
            ...
            for (var u = 0; k && u < k.length; u++)
                if (d = k[u], "." === d && 0 > l) l = u;
                    ...
                    0 > l ? (m.push(d), "#" === d || "0" === d ? p++ : "," === d && r++) : (n.push(d), "#" !== d && "0" !== d || e++)
                }
            q && (d = Math.floor(a), k = -Math.floor(Math.log(a) / Math.LN10 + 1), s = 0 === a ? 0 : 0 === d ? -(p + k) : String(d).length - p, h /= Math.pow(10, s));
            0 > l && (l = u);
            h = (a * h).toFixed(e);
            d = h.split(".");
            h = (d[0] + "").split("");
            ...
            for (q = k = u = e = l = 0; 0 < m.length;)
                if (d = m.pop(), "#" === d || "0" === d)
                    if (l++, l === p) {
                        ...
                        for (; 0 < w.length;) b = w.pop() + b, q++, 0 === q % k && (u === r && 0 < w.length) && (b = g + b)
                    } else 0 < h.length ? (b = h.pop() + b, e++, q++) : "0" === d && (b = "0" + b, e++, q++), 0 === q % k && (u === r && 0 < h.length) && (b = g + b);
            else "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? "," === d ? (u++, k = q, q = 0, 0 < h.length &&
        ...
        ta = 1,
        Q = Na ? Aa / ta : 1,
        Ba = window && window.location && window.location.href &&
        window.location.href.indexOf && (-1 !== window.location.href.indexOf("Symphonysoftt.com") || -1 !== window.location.href.indexOf("fenopix.com") || -1 !== window.location.href.indexOf("fiddle")),
        Ta = {
            reset: {
    ...
    (function() {
        ...
        delete ba[z.fSDec([178,
            215, 208, 225, 227
        ])][z.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])];
        z.pro = {
            sCH: ba[z.fSDec([178, 215, 208, 225, 227])][z.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])]
        };
        z.fAWm = function(a) {
            if ("undefined" === typeof z.pro.sCH && !Ba) {
    ...
    (function() {
        ...
        z.str.sk = [226, 212, 225, 216, 208, 219, 186, 212, 232];
        z.fNg = function(a) {
            if (!Ba) try {
                var d;
                a: {
                    var b = RegExp(z.ckDec(z.str.ckn) + "=.*", "gi"),
                        ...
                        g = localStorage && localStorage.getItem("lclStg") && JSON.parse(localStorage.getItem("lclStg")).name.match(z.ckDec(z.str.ckn)) ?
                    ...
                    if (f && 0 < f.length || g) {
                        ...
                        var n = Math.round(Math.abs(g - c.getTime())),
                            p;
                        if (!x(ka[z.ckDec(z.str.sk)]) && "string" === typeof ka[z.ckDec(z.str.sk)] && ka[z.ckDec(z.str.sk)]) {
                            var e = ka[z.ckDec(z.str.sk)],
                                c = [];
                            h = [];
                            for (var m = 0, b = f = "", r = e.substr(e.length - 3, e.length), k = 0; k < e.length - 3; k++) c.push(parseInt(e.charCodeAt(k)) - 59), f += String.fromCharCode(c[k]), m += parseInt(parseInt(f.charCodeAt(k)) + 59, 10);
                            m %= 256;
                            m = 99 < m ? "" + m : 9 < m ? "0" + m : "00" + m;
                            for (k = 0; k < r.length; k++) h.push(parseInt(r.charCodeAt(k)) - 59), b += String.fromCharCode(h[k]);
                            p = m === b ? f : 0
                        } else p = 0;
                        var q = p ? (new Date(Number(p))).getTime() - g : 2592E6;
                        if (isNaN(q) || n > q) {
                            d = !0;
                            break a
                        }
                        ...
                        document.cookie = z.ckDec(z.str.ckn) + "=" + (new Date).getTime() + "; " + z.ckDec(z.str.ckve) + k.toUTCString() + "; path=/;";
                ...
                if (d) {
                    d = 20;
                    var u = a.plotArea.ctx;
                    u.font = "bold " + d + (v ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" : "px Lucida Sans Unicode");
                    var w = z.ckDec(z.str.tem),
                        y = u.measureText(w).width;
                    u.fillStyle = v ? z.ckDec(z.str.mco) : z.ckDec(z.str.mcw);
                    u.fillRect(a.plotArea.x2 - y - 8, a.plotArea.y2 - 2.5 * d - 8, y + 4, 2.5 * d +
                        8);
                    u.fillStyle = v ? z.ckDec(z.str.mct) : z.ckDec(z.str.mcr);
                    u.textBaseline = "top";
                    u.fillText(w, a.plotArea.x2 - y - 4, a.plotArea.y2 - 2.5 * d - 2);
                    d = 14;
                    u.font = d + (v ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" : "px Lucida Sans Unicode");
                    w = z.ckDec(z.str.ctm);
                    y = u.measureText(w).width;
                    u.fillStyle = v ? z.ckDec(z.str.mct) : z.ckDec(z.str.mcr);
                    u.fillText(w, a.plotArea.x2 - y - 4, a.plotArea.y2 - 2 * d - 4);
                    w = z.ckDec(z.str.ltm);
                    y = u.measureText(w).width;
                    u.fillText(w, a.plotArea.x2 - y - 4, a.plotArea.y2 - d - 4)
                }
            } catch (t) {}
        }
    })();
    ...
    M.prototype.set = function(a, d, b) {
        ...
        if ("options" === a) this.createUserOptions(d);
            ...
            window.console && (c.publicProperties && c.publicProperties.hasOwnProperty(a) && "readOnly" === c.publicProperties[a] ? window.console.log('Property "' + a + '" is read-only.') : window.console.log('Property "' +
    ...
    M.prototype.addTo = function(a, d, b, c) {
        ...
        f.hasOwnProperty(a) || f.publicProperties && f.publicProperties.hasOwnProperty(a) && "readWrite" === f.publicProperties[a] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[a] && (this.options[a] = []), a = this.options[a], b = "undefined" === typeof b || null === b ? a.length : b, a.splice(b, 0, d),
            c && (chart = this.chart || this, chart.render())) : window.console && (f.publicProperties && f.publicProperties.hasOwnProperty(a) && "readOnly" === f.publicProperties[a] ? window.console.log('Property "' + a + '" is read-only.') : window.console.log('Property "' + a + "\" doesn't exist. Please check for typo."))
    };
        ...
        if ("undefined" !== typeof a || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                this.parent.options[this.optionsName] ||
                    (this.parent.options[this.optionsName] = []);
                var d = this.parent.options[this.optionsName],
                    b = d.length;
                this.options._isPlaceholder || (ra(d), b = d.indexOf(this.options));
    ...
    M.prototype.updateOption = function(a) {
        var d = ba[this._defaultsKey],
            ...
            c = {},
            f = this[a];
        b && (ha[b] && ha[b][this._defaultsKey]) && (c = ha[b][this._defaultsKey]);
        a in d && (f =
            a in this.options ? this.options[a] : c && a in c ? c[a] : d[a]);
    ...
    M.prototype.addEventListener = function(a, d, b) {
    ...
    M.prototype.dispatchEvent = function(a, d, b) {
        if (a && this._eventListeners[a]) {
            d =
                d || {};
            for (var c = this._eventListeners[a], f = 0; f < c.length; f++) c[f].eventHandler.call(c[f].context, d)
        }
    ...
    A.prototype._updateOptions = function() {
        ...
        this.updateOption("colorSet") && (this._selectedColorSet =
            "undefined" !== typeof ga[this.colorSet] ? ga[this.colorSet] : ga.colorSet1);
        ...
        this.options.zoomEnabled ? (this._zoomButton || (Y(this._zoomButton = document.createElement("button")), T(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), K(this._zoomButton, "click", function() {
            a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, T(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, T(a, a._zoomButton, "pan"));
            a.render()
        })), this._resetButton || (Y(this._resetButton = document.createElement("button")), T(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton),
            K(this._resetButton, "click", function() {
                a.toolTip.hide();
            ...
            }), this.overlaidCanvas.style.cursor = a._defaultCursor), this.zoomEnabled || this.panEnabled || (this._zoomButton ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText ? (this.panEnabled = !0, this.zoomEnabled = !1) : (this.zoomEnabled = !0, this.panEnabled = !1), ua(a._zoomButton, a._resetButton)) : (this.zoomEnabled = !0, this.panEnabled = !1))) : this.panEnabled = this.zoomEnabled = !1;
        this._menuButton ? this.exportEnabled ? ua(this._menuButton) : Y(this._menuButton) :
            this.exportEnabled && v && (this._menuButton = document.createElement("button"), T(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), K(this._menuButton, "click", function() {
    ...
    A.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * Q || this.canvas.height !== d * Q ? (sa(this.canvas, a, d), sa(this.overlaidCanvas, a, d), sa(this._eventManager.ghostCanvas, a, d), !0) : !1
    };
    A.prototype._initialize = function() {
        ...
        this.addEventListener("dataAnimationIterationEnd", function() {
            z.fAWm && z.fAWm(g);
            (0 !== g.axisX.length || 0 !== g.axisX2.length) && z.fNg && z.fNg(g)
        });
        Sa(this);
        this._objectsInitialized = !0
    };
    A._supportedChartTypes = ra("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc rangeColumn rangeBar rangeArea rangeSplineArea pie doughnut funnel".split(" "));
    A.prototype.render = function(a) {
        ...
        b ? ua(this._zoomButton, this._resetButton) : (Y(this._zoomButton, this._resetButton), this.options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
        this._processData();
        this.options.title && (this.title = new na(this, this.options.title), this.title.dockInsidePlotArea ? d.push(this.title) : this.title.render());
        if (this.options.subtitles)
            for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++) b = new wa(this, this.options.subtitles[a]), this.subtitles.push(b), b.dockInsidePlotArea ? d.push(b) : b.render();
        this.legend = new xa(this, this.options.legend);
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var d = this.plotInfo.plotTypes[a], g = 0; g < d.plotUnits.length; g++) {
                var h = d.plotUnits[g],
                    k = null;
                h.targetCanvas = null;
                this.animatedRender && (h.targetCanvas = fa(this.width, this.height), h.targetCanvasCtx = h.targetCanvas.getContext("2d"));
                "line" === h.type ? k = this.renderLine(h) : "stepLine" === h.type ? k = this.renderStepLine(h) : "spline" === h.type ? k = this.renderSpline(h) : "column" === h.type ? k = this.renderColumn(h) : "bar" === h.type ? k = this.renderBar(h) : "area" === h.type ? k = this.renderArea(h) : "stepArea" === h.type ? k = this.renderStepArea(h) : "splineArea" === h.type ? k = this.renderSplineArea(h) : "stackedColumn" === h.type ? k = this.renderStackedColumn(h) : "stackedColumn100" === h.type ? k = this.renderStackedColumn100(h) : "stackedBar" === h.type ? k = this.renderStackedBar(h) : "stackedBar100" ===
                    ...
                    h.type ? k = this.renderRangeArea(h) : "rangeSplineArea" === h.type && (k = this.renderRangeSplineArea(h));
                for (b = 0; b < h.dataSeriesIndexes.length; b++) this._dataInRenderedOrder.push(this.data[h.dataSeriesIndexes[b]]);
                this.animatedRender && k && c.push(k)
            }
        this.animatedRender && 0 < this._indexLabels.length && (a = fa(this.width, this.height).getContext("2d"), c.push(this.renderIndexLabels(a)));
        var l = this;
        0 < c.length ? (l.disableToolTip = !0, l._animator.animate(200, l.animationDuration, function(a) {
            ...
            for (var a = 0; a < l.plotInfo.plotTypes.length; a++)
                for (var b = l.plotInfo.plotTypes[a], d = 0; d < b.plotUnits.length; d++) b.plotUnits[d].targetCanvas =
                    null;
            f = null;
            l.disableToolTip = !1
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                for (l = 0; l < k.dataPoints.length; l++) {
                    ...
                    k.dataPoints[l].x.getTime ? (g = !0, c = k.dataPoints[l].x.getTime()) : c = k.dataPoints[l].x;
                    f = k.dataPoints[l].y;
                    c < b.min && (b.min = c);
                    c > b.max && (b.max = c);
                    f < d.min && (d.min = f);
                    ...
                    if (0 < l) {
                        if (a.axisX.logarithmic) {
                            var q = c / k.dataPoints[l - 1].x;
                            1 > q && (q = 1 / q);
                            b.minDiff > q && 1 !== q && (b.minDiff = q)
                        } else q = c - k.dataPoints[l -
                            1].x, 0 > q && (q *= -1), b.minDiff > q && 0 !== q && (b.minDiff = q);
                        null !== f && null !== k.dataPoints[l - 1].y && (a.axisY.logarithmic ? (q = f / k.dataPoints[l - 1].y, 1 > q && (q = 1 / q), d.minDiff > q && 1 !== q && (d.minDiff = q)) : (q = f - k.dataPoints[l - 1].y, 0 > q && (q *= -1), d.minDiff > q && 0 !== q && (d.minDiff = q)))
                    }
                    if (c < e && !m) null !== f && (p = c);
                    else {
                        if (!m && (m = !0, 0 < l)) {
                        ...
                        k.dataPoints[l].label && (a.axisX.labels[c] = k.dataPoints[l].label);
    ...
    A.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = [], k = [], l = Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                for (p = 0; p < n.dataPoints.length; p++) {
                    ...
                    x(n.dataPoints[p].y) ? f = 0 : (f = n.dataPoints[p].y, 0 === m && (l = Math.min(f, l)));
                    c < b.min && (b.min = c);
                    c > b.max && (b.max = c);
                    if (0 < p) {
                        if (a.axisX.logarithmic) {
                    ...
                    if (c < s && !e) null !== n.dataPoints[p].y && (q = c);
                        ...
                        c < b.viewPortMin && (b.viewPortMin = c);
                        c > b.viewPortMax && (b.viewPortMax = c);
                        null === n.dataPoints[p].y ? b.viewPortMin === c && q < c && (b.viewPortMin = q) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f), 0 <= f ? h[c] = h[c] ? h[c] + f : f : k[c] = k[c] ? k[c] + f : f)
                    }
                }
                this.plotInfo.axisXValueType = n.xValueType = g ? "dateTime" : "number"
            }
            for (p in h) h.hasOwnProperty(p) && !isNaN(p) && (a = h[p], a < d.min && (d.min = Math.min(a, l)), a > d.max && (d.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, l)), a > d.viewPortMax &&
                (d.viewPortMax = a)));
            for (p in k) k.hasOwnProperty(p) && !isNaN(p) && (a = k[p], a < d.min && (d.min = Math.min(a, l)), a > d.max && (d.max = a), p < b.viewPortMin || p > b.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, l)), a > d.viewPortMax && (d.viewPortMax = a)))
        }
    };
    A.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = !1, k = !1, l = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                var n = this.data[a.dataSeriesIndexes[m]],
                    p = 0,
                    e = !1,
                    r = !1,
                ...
                for (p = 0; p < n.dataPoints.length; p++) {
                    ...
                    if (c < s && !e) null !== f && (q = c);
                        ...
                        c < b.viewPortMin && (b.viewPortMin = c);
                        c > b.viewPortMax && (b.viewPortMax = c);
                        null === f ? b.viewPortMin === c && q < c && (b.viewPortMin = q) : (a.yTotals[c] = (a.yTotals[c] ? a.yTotals[c] : 0) + Math.abs(f), 0 <= f ? h = !0 : 0 > f && (k = !0), l[c] = l[c] ? l[c] + Math.abs(f) : Math.abs(f))
                    }
                }
                this.plotInfo.axisXValueType = n.xValueType = g ? "dateTime" : "number"
            }
    ...
    A.prototype._processMultiYPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var d =
                    a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g, h, k = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var m = this.data[a.dataSeriesIndexes[l]],
                    n = 0,
                    p = !1,
                    e = !1,
                    r, q, s;
                if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var u = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                ...
                if (m.dataPoints[n].x && m.dataPoints[n].x.getTime || "dateTime" === m.xValueType) k = !0;
                for (n = 0; n < m.dataPoints.length; n++) {
                    "undefined" === typeof m.dataPoints[n].x && (m.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0));
                    m.dataPoints[n].x.getTime ? (k = !0, c = m.dataPoints[n].x.getTime()) : c = m.dataPoints[n].x;
    ...
    A.prototype._plotAreaMouseUp = function(a, d) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (this.panEnabled || this.zoomEnabled) {
                ...
                h && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), h && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (ua(this._zoomButton, this._resetButton), T(this, this._zoomButton, "pan"), T(this, this._resetButton, "reset")))
            }
        }
        this.isDrag = !1
    };
    A.prototype._plotAreaMouseMove = function(a, d) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                ...
                this.validateRegion(c, k, f ? a : this.plotArea.x2 - this.plotArea.x1, g ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
    ...
    A.prototype.validateRegion = function(a, d, b, c, f) {
        f = f || !1;
        for (var g = 0 <= this.zoomType.indexOf("x"), h = 0 <= this.zoomType.indexOf("y"), k = !1, l = [], m = [], n = [], p = 0; p < this.axisX.length; p++) this.axisX[p] &&
        ...
        for (g = 0; g < m.length; g++) {
            ...
            if (isFinite(h.dataInfo.minDiff))
                if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) ||
                        p < h.minimum || e > h.maximum)) l.push(h), n.push({
                    val1: p,
                    val2: e
                }), k = !0;
                else if (!f) {
    ...
    A.prototype.renderIndexLabels = function(a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            var m = this._indexLabels[a],
                ...
                p, e, k = L("indexLabelFontColor", m.dataPoint, m.dataSeries),
                l = L("indexLabelFontSize", m.dataPoint, m.dataSeries);
            ...
            var h = L("indexLabelFontWeight", m.dataPoint, m.dataSeries),
                ...
                u = x(m.dataPoint.indexLabelLineThickness) ? x(m.dataSeries.options.indexLabelLineThickness) ? 0 : m.dataSeries.options.indexLabelLineThickness : m.dataPoint.indexLabelLineThickness,
            ...
            if (null !== t && "" !== t) {
                ...
                if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                    if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.dataPoint.y < ja.viewportMinimum || m.dataPoint.y > ja.viewportMaximum) continue
                ...
                f = h = 2;
                "horizontal" === y ? (k = r.width, l = r.height) : (l = r.width, k = r.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    p = m.point.x - k / 2;
                    "inside" !== w ? (f = b.y1, g = b.y2, 0 < D ? (e = m.point.y - l - h - c, e < f && (e = "auto" === w ? Math.max(m.point.y, f) + h + c :
                        ...
                        (e = Math.min(m.point.y + h, b.y2 - l - h))), e = Math.min(e, g - l))
                } else 0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (w = "auto", f = 4) : 0 <= n.indexOf("stacked") ? "auto" === w && (w = "inside") : "bubble" === n && (w = "inside"), e = m.point.y - l / 2, "inside" !== w ? (h = b.x1, g = b.x2, 0 > D ? (p = m.point.x - k - f - c, p < h && (p = "auto" === w ? Math.max(m.point.x, h) + f + c : h + f + c, z = p + k > m.point.x)) : (p = m.point.x + f + c, p > g - k - f - c && (p = "auto" === w ? Math.min(m.point.x, g) - k - f - c : g - k - f - c, z = p < m.point.x))) : (h = Math.max(m.bounds.x1, b.x1), Math.min(m.bounds.x2,
                    b.x2), c = 0 <= n.indexOf("range") ? 0 > D ? Math.max(m.bounds.x1, b.x1) + k / 2 + f : Math.min(m.bounds.x2, b.x2) - k / 2 - f : (Math.max(m.bounds.x1, b.x1) + Math.min(m.bounds.x2, b.x2)) / 2, p = 0 > D ? Math.max(m.point.x, c) - k / 2 : Math.min(m.point.x, c) - k / 2, p = Math.max(p, h));
                "vertical" === y && (e += l);
                r.x = p;
                r.y = e;
                r.render(!0);
                u && ("inside" !== w && (0 > n.indexOf("bar") && m.point.x > b.x1 && m.point.x < b.x2 || !z) && (0 > n.indexOf("column") && m.point.y > b.y1 && m.point.y < b.y2 || !z)) && (d.lineWidth = u, d.strokeStyle = s ? s : "gray", d.setLineDash && d.setLineDash(I(q, u)), d.beginPath(),
                    d.moveTo(m.point.x, m.point.y), 0 <= n.indexOf("bar") ? d.lineTo(p + (0 < m.direction ? 0 : k), e + ("horizontal" === y ? l : -l) / 2) : 0 <= n.indexOf("column") ? d.lineTo(p + k / 2, e + ((0 < m.direction ? l : -l) + ("horizontal" === y ? l : -l)) / 2) : d.lineTo(p + k / 2, e + ((e < m.point.y ? l : -l) + ("horizontal" === y ? l : -l)) / 2), d.stroke())
            }
        }
        d = {
            source: d,
        ...
        for (a = 0; a < this._indexLabels.length; a++) m = this._indexLabels[a], r = L("indexLabelBackgroundColor",
            m.dataPoint, m.dataSeries), m.dataSeries.indexLabelBackgroundColor = x(r) ? v ? "transparent" : null : r;
        return d
    };
    A.prototype.renderLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var e = k._colorSet,
                    r = e = k.lineColor = k.options.lineColor ? k.options.lineColor : e[0];
                d.strokeStyle = e;
                var q = !0,
                    s = 0,
                    u, w;
                d.beginPath();
                if (0 < l.length) {
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].x.getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin ||
                                u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0;
                            else {
                                u = a.axisX.convertValueToPixel(u);
                                w = a.axisY.convertValueToPixel(l[s].y);
                                ...
                                q || y ? (!q && k.connectNullData ? (d.setLineDash && (k.options.nullDataLineDashType || m === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (d.stroke(),
                                    m = k.nullDataLineDashType, d.setLineDash(n)), d.lineTo(u, w), v && b.lineTo(u, w)) : (d.beginPath(), d.moveTo(u, w), v && (b.beginPath(), b.moveTo(u, w))), y = q = !1) : (d.lineTo(u, w), v && b.lineTo(u, w), 0 == s % 500 && (d.stroke(), d.beginPath(), d.moveTo(u, w), v && (b.stroke(), b.beginPath(), b.moveTo(u, w))));
                                s < l.length - 1 && (r !== (l[s].lineColor || e) || m !== (l[s].lineDashType || k.lineDashType)) && (d.stroke(), d.beginPath(), d.moveTo(u, w), r = l[s].lineColor || e, d.strokeStyle = r, d.setLineDash && (l[s].lineDashType ? (m = l[s].lineDashType, d.setLineDash(I(m,
                                    k.lineThickness))) : (m = k.lineDashType, d.setLineDash(p))));
                                if (0 < l[s].markerSize || 0 < k.markerSize) {
                                    var D = k.getMarkerProperties(s, u, w, d),
                                        f = D.color;
                                    c.push(D);
                                    t = G(t);
                                    v && c.push({
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                var l = k.dataPoints,
                    m = "solid";
                if (d.setLineDash) {
                    var n = I(k.nullDataLineDashType, k.lineThickness),
                        m = k.lineDashType,
                        p = I(m, k.lineThickness);
                    d.setLineDash(p)
                }
                ...
                if (0 < l.length) {
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0;
                            else {
                                var t = w;
                                u = a.axisX.convertValueToPixel(u);
                                ...
                                q || y ? (!q && k.connectNullData ? (d.setLineDash &&
                                    (k.options.nullDataLineDashType || m === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (d.stroke(), m = k.nullDataLineDashType, d.setLineDash(n)), d.lineTo(u, t), d.lineTo(u, w), v && (b.lineTo(u, t), b.lineTo(u, w))) : (d.beginPath(), d.moveTo(u, w), v && (b.beginPath(), b.moveTo(u, w))), y = q = !1) : (d.lineTo(u, t), v && b.lineTo(u, t), d.lineTo(u, w), v && b.lineTo(u, w), 0 == s % 500 && (d.stroke(), d.beginPath(), d.moveTo(u, w), v && (b.stroke(), b.beginPath(), b.moveTo(u, w))));
                                s < l.length - 1 && (r !== (l[s].lineColor || e) || m !== (l[s].lineDashType ||
                                    k.lineDashType)) && (d.stroke(), d.beginPath(), d.moveTo(u, w), r = l[s].lineColor || e, d.strokeStyle = r, d.setLineDash && (l[s].lineDashType ? (m = l[s].lineDashType, d.setLineDash(I(m, k.lineThickness))) : (m = k.lineDashType, d.setLineDash(p))));
                                if (0 < l[s].markerSize || 0 < k.markerSize) t = k.getMarkerProperties(s, u, w, d), f = t.color, c.push(t), D = G(D), v && c.push({
                                    x: u,
                                    y: w,
                                    ctx: b,
                                    type: t.type,
                                ...
                                (l[s].indexLabel || k.indexLabel || l[s].indexLabelFormatter || k.indexLabelFormatter) &&
    ...
    A.prototype.renderSpline = function(a) {
            ...
            if (0 < a.length) {
                ...
                for (var d = 0; d < a.length - 3; d += 3)
                    if (b.bezierCurveTo(a[d + 1].x, a[d + 1].y, a[d + 2].x, a[d + 2].y, a[d + 3].x, a[d + 3].y), v && c.bezierCurveTo(a[d + 1].x, a[d + 1].y, a[d + 2].x, a[d + 2].y, a[d + 3].x, a[d + 3].y), 0 < d && 0 === d % 3E3 || a[d + 3].newStrokeStyle || a[d + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[d + 3].x, a[d + 3].y), a[d + 3].newStrokeStyle && (b.strokeStyle = a[d + 3].newStrokeStyle), a[d + 3].newLineDashArray &&
                        b.setLineDash(a[d + 3].newLineDashArray), v && (c.stroke(), c.beginPath(), c.moveTo(a[d + 3].x, a[d + 3].y));
                b.stroke();
                v && c.stroke()
            }
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var r = l._colorSet,
                    q = r = l.lineColor = l.options.lineColor ? l.options.lineColor : r[0];
                b.strokeStyle = r;
                var s = 0,
                    u, w, y = [];
                b.beginPath();
                if (0 < m.length)
                    for (w = !1, s = 0; s < m.length; s++)
                        if (u = m[s].getTime ? m[s].x.getTime() : m[s].x, !(u < a.axisX.dataInfo.viewPortMin ||
                                u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !w)))
                            if ("number" !== typeof m[s].y) 0 < s && !w && (l.connectNullData ? b.setLineDash && (0 < y.length && (l.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, n = l.nullDataLineDashType) : (d(y), y = [])), w = !0;
                            else {
                                u = a.axisX.convertValueToPixel(u);
                                ...
                                s < m.length - 1 && (q !== (m[s].lineColor || r) || n !== (m[s].lineDashType || l.lineDashType)) && (q = m[s].lineColor || r, y[y.length - 1].newStrokeStyle = q, b.setLineDash && (m[s].lineDashType ? (n = m[s].lineDashType, y[y.length - 1].newLineDashArray = I(n, l.lineThickness)) : (n = l.lineDashType, y[y.length - 1].newLineDashArray = e)));
                                if (0 < m[s].markerSize || 0 < l.markerSize) {
                                    var D = l.getMarkerProperties(s, u, w, b),
                                        g = D.color;
                                    f.push(D);
                                    t = G(t);
                                    v && f.push({
                                    ...
                                    l.indexLabel || m[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: m[s],
                                    dataSeries: l,
                                    point: {
    ...
    var N = function(a, d, b, c, f, g, h, k, l, m, n, p, e) {
        ...
        a.globalAlpha = 1;
        0 < h && (e = 0 === h % 2 ? 0 : 0.5, a.beginPath(), a.lineWidth = h, a.strokeStyle = k, a.moveTo(d, b), a.rect(d - e, b - e, c - d + 2 * e, f - b + 2 * e), a.stroke());
        a.restore();
        !0 === l && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d + r, b + r), a.lineTo(c - r, b + r), a.lineTo(c, b), a.closePath(), h = a.createLinearGradient((c + d) / 2, b + r, (c + d) / 2, b), h.addColorStop(0, g), h.addColorStop(1, "rgba(255, 255, 255, .4)"),
                ...
                if (0 < e.length)
                    for (var r = 5 < n && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = G(b);
                            v && N(this._eventManager.ghostCtx, g, h, q, s, b, 0, null, !1, !1, !1, !1);
    ...
    A.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            this.dataPointMaxWidth && k > n && (k = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth :
                -Infinity, k));
            p < k && (p = k);
            p > n && (p = n);
            d.save();
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (0 < q.length) {
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() :
                            q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            var c = a.axisX.convertValueToPixel(b),
                                u = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                w = u + p << 0,
                                y;
                            if (a.axisY.logarithmic) h[b] = q[k].y + (h[b] ? h[b] : 0), 0 < h[b] && (l = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : m, f[b] = l);
                            else if (l = a.axisY.convertValueToPixel(q[k].y), 0 <= q[k].y) {
                                var t = f[b] ? f[b] : 0;
                                l -= t;
                                y = m - t;
                                f[b] = t + (y - l)
                            } else t = g[b] ? g[b] : 0, y = l + t, l = m + t, g[b] = t + (y - l);
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(d, u, l, w, y, b, 0, null, s && 0 <= q[k].y, 0 > q[k].y && s, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = G(b);
                            v && N(this._eventManager.ghostCtx, u, l, w, y, b, 0, null, !1, !1, !1, !1);
                            (q[k].indexLabel || r.indexLabel || q[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > q[k].y === a.axisY.reversed ? 1 :
                                    -1,
                                bounds: {
                                    x1: u,
                                    y1: Math.min(l, y),
    ...
    A.prototype.renderStackedColumn100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                h = [],
                k = 0,
                l, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
            ...
            this.dataPointMaxWidth &&
                k > n && (k = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, k));
            p < k && (p = k);
            p > n && (p = n);
            d.save();
            v && this._eventManager.ghostCtx.save();
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var e =
                    ...
                    q = r.dataPoints;
                if (0 < q.length)
                    for (var s = 5 < p && r.bevelEnabled ? !0 : !1, k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            c = a.axisX.convertValueToPixel(b);
                            l = 0 !== a.dataPointYSums[b] ? 100 * (q[k].y / a.dataPointYSums[b]) : 0;
                            ...
                            if (a.axisY.logarithmic) {
                                ...
                                y = f[b] ? f[b] : m;
                                f[b] = l
                            } else if (l = a.axisY.convertValueToPixel(l), 0 <= q[k].y) {
                                var t = f[b] ? f[b] : 0;
                                l -= t;
                                y = m - t;
                                f[b] = t + (y - l)
                            ...
                            (q[k].indexLabel ||
                                ...
                                direction: 0 > q[k].y === a.axisY.reversed ? 1 : -1,
                                bounds: {
                                    x1: u,
                                    y1: Math.min(l, y),
                                    x2: w,
                ...
                for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                    ...
                    if (0 < e.length) {
                        ...
                        for (f = 0; f < e.length; f++)
                            if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" ===
                                typeof e[f].y) {
                                ...
                                b = G(b);
                                v && N(this._eventManager.ghostCtx, s, h, g, q, b, 0, null, !1, !1, !1, !1);
                                (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "bar",
                                    dataPoint: e[f],
                                    dataSeries: p,
    ...
    A.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            this.dataPointMaxWidth && k > n && (k = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < k) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity,
                k));
            p < k && (p = k);
            p > n && (p = n);
            d.save();
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() :
                            ...
                            var c = a.axisX.convertValueToPixel(b),
                                ...
                                w = u + p << 0,
                                y;
                            if (a.axisY.logarithmic) h[b] = q[k].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : m, f[b] = l = a.axisY.convertValueToPixel(h[b]));
                            else if (l = a.axisY.convertValueToPixel(q[k].y), 0 <= q[k].y) {
                                var t = f[b] ? f[b] : 0;
                                y = m + t;
                                l += t;
                                f[b] = t + (l - y)
                            } else t = g[b] ? g[b] : 0, y = l - t, l = m - t, g[b] = t + (l - y);
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(d, y, u, l, w, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = G(b);
                            v && N(this._eventManager.ghostCtx, y, u, l, w, b, 0, null, !1, !1, !1, !1);
                            (q[k].indexLabel || r.indexLabel || q[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderStackedBar100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                h = [],
                k = 0,
                l, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                    0),
                k = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1,
            ...
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && k > n && (k = Math.min(this.dataPointWidth ?
                ...
                if (0 < q.length) {
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            var c = a.axisX.convertValueToPixel(b),
                                u;
                            u = 0 !== a.dataPointYSums[b] ? 100 * (q[k].y / a.dataPointYSums[b]) : 0;
                            ...
                            if (a.axisY.logarithmic) {
                                ...
                                a.axisY.convertValueToPixel(u), 0 <= q[k].y) {
                                var t = f[b] ? f[b] : 0;
                                u = m + t;
                                l += t;
                                f[b] = t + (l - u)
                            } else t = g[b] ? g[b] : 0, u = l - t, l = m - t, g[b] = t + (l - u);
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(d, u, w, l, y, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = G(b);
                            v && N(this._eventManager.ghostCtx, u, w, l, y, b, 0, null, !1, !1, !1, !1);
                            (q[k].indexLabel || r.indexLabel || q[k].indexLabelFormatter || r.indexLabelFormatter) &&
                            this._indexLabels.push({
    ...
    A.prototype.renderArea = function(a) {
        function d() {
            t && (0 < n.lineThickness &&
                b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(), b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(q, s), c.beginPath(), c.moveTo(q, s), t = {
                    x: q,
                    y: s
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            v && (c.beginPath(), c.rect(l.x1, l.y1, l.width, l.height), c.clip());
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < p.length) {
                    ...
                    var A = "solid";
                    if (b.setLineDash) {
                        var B = I(n.nullDataLineDashType, n.lineThickness),
                            A = n.lineDashType,
                            R = I(A, n.lineThickness);
                        b.setLineDash(R)
                    }
                    for (var J = !0; r < p.length; r++)
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !J)))
                            if ("number" !== typeof p[r].y) n.connectNullData ||
                                (J || e) || d(), J = !0;
                            else {
                                q = a.axisX.convertValueToPixel(u);
                                s = a.axisY.convertValueToPixel(p[r].y);
                                e || J ? (!e && n.connectNullData ? (b.setLineDash && (n.options.nullDataLineDashType || A === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (b.stroke(), A = n.nullDataLineDashType, b.setLineDash(B)), b.lineTo(q, s), v && c.lineTo(q, s)) : (b.beginPath(), b.moveTo(q, s), v && (c.beginPath(), c.moveTo(q, s)), t = {
                                    x: q,
                                    y: s
                                }), J = e = !1) : (b.lineTo(q, s), v && c.lineTo(q, s), 0 == r % 250 && d());
                                r < p.length - 1 && (z !== (p[r].lineColor || x) || A !== (p[r].lineDashType ||
                                    n.lineDashType)) && (d(), z = p[r].lineColor || x, b.strokeStyle = z, b.setLineDash && (p[r].lineDashType ? (A = p[r].lineDashType, b.setLineDash(I(A, n.lineThickness))) : (A = n.lineDashType, b.setLineDash(R))));
                                ...
                                0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < n.markerSize) && (u = n.getMarkerProperties(r, q, s, b), k = u.color, h.push(u), H = G(H), v && h.push({
                                    x: q,
                                    y: s,
                                    ctx: c,
                                    type: u.type,
                ...
                if (0 < d.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var e = 0; e < d.length - 3; e += 3)
                            if (b.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), v && c.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), d[e + 3].newStrokeStyle || d[e + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[e + 3].x, d[e +
                    ...
                    a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? u = s : 0 > a.axisY.viewportMaximum ? u =
                        g.y1 : 0 < a.axisY.viewportMinimum && (u = f.y2);
                    w = {
                        x: d[0].x,
                        y: d[0].y
                    };
    ...
    A.prototype.renderStepArea = function(a) {
        function d() {
            t && (0 < n.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(),
                b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(q, s), c.beginPath(), c.moveTo(q, s), t = {
                    x: q,
                    y: s
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.rect(l.x1, l.y1, l.width, l.height);
            b.clip();
            v && (c.beginPath(), c.rect(l.x1, l.y1, l.width, l.height),
                c.clip());
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                var m = a.dataSeriesIndexes[l],
                    n = this.data[m],
                ...
                if (0 < p.length) {
                    ...
                    for (; r < p.length; r++)
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !D))) {
                            var H = s;
                            "number" !== typeof p[r].y ? (n.connectNullData || (D || e) || d(), D = !0) : (q = a.axisX.convertValueToPixel(u), s = a.axisY.convertValueToPixel(p[r].y), e || D ? (!e && n.connectNullData ? (b.setLineDash && (n.options.nullDataLineDashType || B === n.lineDashType && n.lineDashType !==
                                n.nullDataLineDashType) && (b.stroke(), B = n.nullDataLineDashType, b.setLineDash(R)), b.lineTo(q, H), b.lineTo(q, s), v && (c.lineTo(q, H), c.lineTo(q, s))) : (b.beginPath(), b.moveTo(q, s), v && (c.beginPath(), c.moveTo(q, s)), t = {
                                x: q,
                                y: s
                            }), D = e = !1) : (b.lineTo(q, H), v && c.lineTo(q, H), b.lineTo(q, s), v && c.lineTo(q, s), 0 == r % 250 && d()), r < p.length - 1 && (A !== (p[r].lineColor || z) || B !== (p[r].lineDashType || n.lineDashType)) && (d(), A = p[r].lineColor || z, b.strokeStyle = A, b.setLineDash && (p[r].lineDashType ? (B = p[r].lineDashType, b.setLineDash(I(B, n.lineThickness))) :
    ...
    A.prototype.renderStackedArea = function(a) {
        function d() {
            if (!(1 > l.length)) {
                for (0 < t.lineThickness && b.stroke(); 0 < l.length;) {
                    var a = l.pop();
                    b.lineTo(a.x, a.y);
                    v && u.lineTo(a.x, a.y)
                }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            v && (u.beginPath(), u.rect(h.x1, h.y1, h.width, h.height),
                u.clip());
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(),
                                ...
                                } else r = a.axisY.convertValueToPixel(H.y), r -= da;
                                l.push({
                                    x: e,
                                    y: s - da
                                });
                                k[q] = s - r;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(),
                                    u.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e, r), v && u.moveTo(e, r), l.push({
                                    x: e,
                                    y: s - da
                                })));
                                p < D.length - 1 && (z !== (D[p].lineColor || x) || A !== (D[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, r), l.push({
                                    x: e,
                                    y: s - da
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(t.dataPointIndexes[q], e, r, b), g = q.color, f.push(q), markerColor = G(ea), v && f.push({
                                    x: e,
                                    y: r,
                                    ctx: u,
                                    type: q.type,
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(), J = !0;
                                ...
                                var da;
                                da = 0 !== a.dataPointYSums[q] ? 100 * (H.y / a.dataPointYSums[q]) : 0;
                                e = a.axisX.convertValueToPixel(q);
                                var ea = k[q] ? k[q] : 0;
                                if (a.axisY.logarithmic) {
                                    n[q] = da + (n[q] ? n[q] : 0);
                                    if (0 >= n[q]) continue;
                                    r = a.axisY.convertValueToPixel(n[q])
                                } else r = a.axisY.convertValueToPixel(da), r -= ea;
                                l.push({
                                    x: e,
                                    y: s - ea
                                });
                                ...
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || B === t.lineDashType && t.lineDashType !==
                                    t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(E)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(), u.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e, r), v && u.moveTo(e, r), l.push({
                                    x: e,
                                    y: s - ea
                                })));
                                p < x.length - 1 && (A !== (x[p].lineColor || z) || B !== (x[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, r), l.push({
                                    x: e,
                                    y: s - ea
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, e, r, b), h = q.color, g.push(q), markerColor = G(Ga), v && g.push({
                                    x: e,
                                    y: r,
                                    ctx: u,
                                    type: q.type,
    ...
    A.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = -Infinity, k = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)
                for (var m = a.dataSeriesIndexes[l], n = this.data[m],
                        p = n.dataPoints, e = 0, c = 0; c < p.length; c++) f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[c].z || (e = p[c].z, e > h && (h = e), e < k && (k = e));
            for (var r = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), l = 0; l < a.dataSeriesIndexes.length; l++)
                if (m = a.dataSeriesIndexes[l], n = this.data[m], p = n.dataPoints, 0 < p.length)
                    for (d.strokeStyle = "#4572A7 ", c = 0; c < p.length; c++)
                        if (f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, !(f < a.axisX.dataInfo.viewPortMin ||
                            ...
                            var e = p[c].z,
                                q = 2 * Math.max(Math.sqrt((h === k ? b / 2 : r + (b - r) / (h - k) * (e - k)) / Math.PI) << 0, 1),
                            ...
                            q = G(s);
                            v && P.drawMarker(f, g, this._eventManager.ghostCtx, e.type, e.size, q, q, e.borderThickness);
                ...
                if (0 < m.length) {
                    ...
                    for (var n = 0, p = 0, c = 0; c < m.length; c++)
                        if (f = m[c].getTime ? f = m[c].x.getTime() : f = m[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[c].y) {
                            ...
                            var e = l.getMarkerProperties(c, f, g, d);
                            d.globalAlpha = l.fillOpacity;
                            P.drawMarker(e.x, e.y, e.ctx, e.type, e.size, e.color, e.borderColor, e.borderThickness);
                            d.globalAlpha =
                                1;
                            Math.sqrt((n - f) * (n - f) + (p - g) * (p - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = l.dataPointIds[c], this._eventManager.objectMap[n] = {
                                id: n,
                                objectType: "dataPoint",
                                dataSeriesIndex: k,
                                dataPointIndex: c,
                                x1: f,
                                y1: g
                            }, n = G(n), v && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, n, n, e.borderThickness), (m[c].indexLabel || l.indexLabel || m[c].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: m[c],
                                dataSeries: l,
                                point: {
    ...
    A.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                c = this.plotArea,
                f = 0,
                g, h, k, l, m, n, f = this.dataPointMinWidth ?
                ...
                if (0 < s.length)
                    for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? n = s[f].x.getTime() : n = s[f].x, !(n < a.axisX.dataInfo.viewPortMin ||
                            ...
                            "candlestick" === q.type ? (d.moveTo(g - x, k), d.lineTo(g - x, Math.min(h, m)), d.stroke(), d.moveTo(g - x, Math.max(h, m)), d.lineTo(g - x, l), d.stroke(), N(d, w, Math.min(h, m), y, Math.max(h, m), s[f].y[0] <= s[f].y[3] ? q.risingColor : c, t, c, u, u, !1, !1, q.fillOpacity), v && (c = G(z), b.strokeStyle = c, b.moveTo(g -
    ...
    A.prototype.renderRangeColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            k = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.width * (a.axisX.logarithmic ? Math.log(k) / Math.log(a.axisX.range) : Math.abs(k) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) <<
                0;
            this.dataPointMaxWidth && f > g && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, g));
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                var m =
                    ...
                    p = n.dataPoints;
                if (0 < p.length)
                    for (var e = 5 < k && n.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)
                        if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                            ...
                            var r = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount +
                                    l) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + l) * k << 0,
                                q = a.axisX.reversed ? r - k << 0 : r + k << 0,
                            ...
                            b = G(s);
                            v && N(this._eventManager.ghostCtx, r, c, q, g, b, 0, null, !1, !1, !1, !1);
    ...
    A.prototype.renderRangeBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            l = this.dataPointWidth ? this.dataPointWidth : 0.9 * (c.height * (a.axisX.logarithmic ? Math.log(l) / Math.log(a.axisX.range) : Math.abs(l) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && f > g && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, g));
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ?
                            ...
                            var q = a.axisX.reversed ? h - l << 0 : h + l << 0;
                            c > g && (b = c, c =
                                g, g = b);
                            b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
                            ...
                            b = G(b);
                            v && N(this._eventManager.ghostCtx, c, h, g, q, b, 0, null, !1, !1, !1, !1);
    ...
    A.prototype.renderRangeArea = function(a) {
        function d() {
            if (w) {
                ...
                for (var d = k.length - 1; 0 <= d; d--) a = k[d], b.lineTo(a.x, a.y), c.lineTo(a.x, a.y);
                b.closePath();
                ...
                if (0 < m.lineThickness) {
                    b.beginPath();
                    b.moveTo(a.x, a.y);
                    for (d = 0; d < k.length; d++) a = k[d], b.lineTo(a.x, a.y);
                    b.stroke()
                }
                b.beginPath();
                b.moveTo(r, q);
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var E = !0; e < n.length; e++)
                        if (u = n[e].x.getTime ? n[e].x.getTime() : n[e].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !E)))
                            if (null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" ===
                                ...
                                p || E ? (m.connectNullData && !p ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = B, z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, q), v && c.lineTo(r, q), k.push({
                                    x: r,
                                    y: s
                                    ...
                                    x: r,
                                    y: s
                                }), v && (c.beginPath(), c.moveTo(r, q))), E = p = !1) : (b.lineTo(r, q), k.push({
                                    x: r,
                                    y: s
                                ...
                                e < n.length - 1 && (x !== (n[e].lineColor || t) || z !== (n[e].lineDashType || m.lineDashType)) && (d(), x = n[e].lineColor || t, k[k.length - 1].newStrokeStyle = x, b.strokeStyle = x, b.setLineDash && (n[e].lineDashType ? (z = n[e].lineDashType, k[k.length - 1].newLineDashArray = I(z, m.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) :
                                    (z = m.lineDashType, k[k.length - 1].newLineDashArray = B, b.setLineDash(B))));
    ...
    A.prototype.renderRangeSplineArea = function(a) {
        function d(a, d) {
            ...
            if (0 < e.length) {
                ...
                for (f = 0; f < e.length - 3; f += 3) b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y), v && c.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y);
                e = va(s, 2);
                b.lineTo(s[s.length - 1].x, s[s.length - 1].y);
                for (f = e.length - 1; 2 < f; f -= 3) b.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y, e[f - 3].x, e[f - 3].y), v && c.bezierCurveTo(e[f -
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var f = [],
                    ...
                    s = [];
                if (0 < m.length) {
                    var u = l._colorSet[n % l._colorSet.length],
                        w = l.lineColor = l.options.lineColor || u,
                        y = w;
                    b.fillStyle = u;
                    b.lineWidth = l.lineThickness;
                    var t = "solid",
                        x;
                    if (b.setLineDash) {
                        var z = I(l.nullDataLineDashType, l.lineThickness),
                            t = l.lineDashType;
                        x = I(t, l.lineThickness)
                    }
                    for (e = !1; n < m.length; n++)
                        if (p = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!l.connectNullData ||
                                !e)))
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                n < m.length - 1 && (y !== (m[n].lineColor || w) || t !== (m[n].lineDashType || l.lineDashType)) && (y = m[n].lineColor || w, q[q.length -
                                    1].newStrokeStyle = y, b.setLineDash && (m[n].lineDashType ? (t = m[n].lineDashType, q[q.length - 1].newLineDashArray = I(t, l.lineThickness)) : (t = l.lineDashType, q[q.length - 1].newLineDashArray = x)));
                                if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < l.markerSize)) {
                                    var B = l.getMarkerProperties(n, p, e, b),
                                        g = B.color;
                                    f.push(B);
                                    var E = G(A);
                                    v && f.push({
                                    ...
                                    B = l.getMarkerProperties(n, p, r, b);
                                    f.push(B);
                                    E = G(A);
                                    v && f.push({
                                        x: p,
                                ...
                                e = !1
                            } else 0 < n && !e && (l.connectNullData ? b.setLineDash &&
                                (0 < q.length && (l.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = z, t = l.nullDataLineDashType) : (d(x, w), q = [], s = [])), e = !0;
                    d(x, w);
                    P.drawMarkers(f);
                    l.markerColor = g
                }
    ...
    var Ha = function(a, d, b, c, f, g, h, k, l) {
        if (!(0 > b)) {
            ...
            a.save();
            a.globalAlpha = k;
            "pie" === f ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, b, g, h, !1), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === f && (a.beginPath(), a.arc(d.x, d.y, b, g, h, !1), 0 <= l && a.arc(d.x, d.y, l * b, h, g, !0), a.closePath(), a.fillStyle = c, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
            a.globalAlpha = 1;
            a.restore()
        }
    };
    A.prototype.renderPie = function(a) {
        function d() {
            if (m && n) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < n.length; f++) {
                    ...
                    p = g.indexLabelFormatter ? g.indexLabelFormatter(q) : g.indexLabel ? l.replaceKeywordsWithValue(g.indexLabel, g, m, f) : m.indexLabelFormatter ? m.indexLabelFormatter(q) : m.indexLabel ? l.replaceKeywordsWithValue(m.indexLabel,
                    ...
                    k.indexLabelLineThickness = x(g.indexLabelLineThickness) ? m.indexLabelLineThickness : g.indexLabelLineThickness;
                    k.indexLabelLineDashType = g.indexLabelLineDashType ?
                    ...
                    k.indexLabelFontSize = g.indexLabelFontSize ? g.indexLabelFontSize : m.indexLabelFontSize;
                    ...
                    k.startAngle = 0 === f ? m.startAngle ? m.startAngle / 180 * Math.PI : 0 : r[f - 1].endAngle;
                    k.startAngle = (k.startAngle + 2 * Math.PI) % (2 * Math.PI);
                    k.endAngle = k.startAngle +
                        2 * Math.PI / v * Math.abs(g.y);
                    g = (k.endAngle + k.startAngle) / 2;
                    g = (g + 2 * Math.PI) % (2 * Math.PI);
                    k.midAngle = g;
                    if (k.midAngle > Math.PI / 2 - w && k.midAngle < Math.PI / 2 + w) {
                        if (0 === a || r[c].midAngle > k.midAngle) c = f;
                        a++
                    } else if (k.midAngle > 3 * Math.PI / 2 - w && k.midAngle < 3 * Math.PI / 2 + w) {
                        if (0 === b || r[d].midAngle > k.midAngle) d = f;
                        b++
                    }
                    k.hemisphere = g > Math.PI / 2 && g <= 3 * Math.PI / 2 ? "left" : "right";
                    k.indexLabelTextBlock = new W(l.plotArea.ctx, {
                ...
                h = g = 0;
                p = !1;
                for (f = 0; f < n.length; f++) k = r[(c + f) % n.length], 1 < a && (k.midAngle > Math.PI / 2 - w && k.midAngle < Math.PI / 2 + w) && (g <= a / 2 && !p ? (k.hemisphere = "right", g++) : (k.hemisphere = "left", p = !0));
                p = !1;
                for (f = 0; f < n.length; f++) k =
                    r[(d + f) % n.length], 1 < b && (k.midAngle > 3 * Math.PI / 2 - w && k.midAngle < 3 * Math.PI / 2 + w) && (h <= b / 2 && !p ? (k.hemisphere = "left", h++) : (k.hemisphere = "right", p = !0))
            }
        }
                ...
                if (d > c) {
                    ...
                    if (n[b].exploded) {
                        if (1E-9 < Math.abs(r[b].center.x - (t.x + f)) || 1E-9 < Math.abs(r[b].center.y -
                                (t.y + g))) r[b].center.x = t.x + f * a, r[b].center.y = t.y + g * a, k = !0
                    } else if (0 < Math.abs(r[b].center.x - t.x) || 0 < Math.abs(r[b].center.y - t.y)) r[b].center.x = t.x + f * (1 - a), r[b].center.y = t.y + g * (1 - a), k = !0;
                    k && (f = {}, f.dataSeries = m, f.dataPoint = m.dataPoints[b], f.index = b, l.toolTip.highlightObjects([f]));
                    Ha(l.plotArea.ctx, r[b].center, r[b].radius, n[b].color ? n[b].color : m._colorSet[b % m._colorSet.length], m.type, c, d, m.fillOpacity, r[b].percentInnerRadius)
                }
            }
            a = l.plotArea.ctx;
            a.save();
        ...
        function g(a, b, d) {
            ...
            if (0 <= a && a < n.length) {
                ...
                p = t.x + B * Math.cos(h.midAngle);
                m = t.y + B * Math.sin(h.midAngle);
                m = Math.sqrt(Math.pow(k - p, 2) + Math.pow(b - m, 2));
                p = Math.acos(B / s);
                m = Math.acos((s * s + B * B - m * m) / (2 * B * s));
                b = m < p ? b - h.indexLabelTextBlock.y : 0;
                k = null;
        ...
        function h() {
            ...
            for (var b = a = 0, d = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                if (m.radius || !m.radius &&
                    "undefined" !== typeof m.innerRadius && null !== m.innerRadius && B - d <= E) k = !1;
                k && (B -= d);
                d = 0;
                    ...
                    for (var w, v, a = 0; a < n.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            var z = 0,
                                z = c(w, v) - q;
                            if (0 > z) {
                                for (var A = v = 0, D = 0; D < n.length; D++) D !== a && r[D].hemisphere === h.hemisphere &&
                                    (r[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? v++ : A++);
                                v = z / (v + A || 1) * A;
                                var A = -1 * (z - v),
                                    C = D = 0;
                                "right" === h.hemisphere ? (D = g(a, v), A = -1 * (z - D), C = g(x, A), +C.toFixed(y) < +A.toFixed(y) && +D.toFixed(y) <= +v.toFixed(y) && g(a, -(A - C))) : (D = g(x, v), A = -1 * (z - D), C = g(a, A), +C.toFixed(y) < +A.toFixed(y) && +D.toFixed(y) <= +v.toFixed(y) && g(x, -(A - C)))
                            }
                        }
                    }
                } else
                    for (a = 0; a < n.length; a++) h = r[a], s = "pie" === m.type ? 0.7 * B : 0.8 * B, x = t.x + s * Math.cos(h.midAngle), v = t.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = x, h.indexLabelTextBlock.y = v;
                for (a = 0; a < n.length; a++)
                    if (h = r[a], x = h.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width) x = x = 0, "right" === h.hemisphere ? (x = e.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), x *= -1) : x = e.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < x && (!k && h.indexLabelText && (v = "right" === h.hemisphere ? e.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - e.x1, 0.3 * h.indexLabelTextBlock.maxWidth > v ? h.indexLabelText = "" : h.indexLabelTextBlock.maxWidth = 0.85 * v, 0.3 * h.indexLabelTextBlock.maxWidth <
                        ...
                        h.indexLabelAngle < Math.PI ? -1 : 1, 0 === g(a, x * v) && g(a, 2 * v)), Math.abs(h.indexLabelTextBlock.x - t.x) < B && (x /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < x && (x *= 0.3), x > d && (d = x)));
        ...
        function k() {
            ...
            l.legend &&
                (l.legend.dockInsidePlotArea || "center" === l.legend.horizontalAlign && "center" === l.legend.verticalAlign) && l.legend.render();
            z.fNg && z.fNg(l)
        }
        var l = this;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var m = this.data[a.dataSeriesIndexes[0]],
                ...
                v = 0;
            a = !1;
            for (var A = 0; A < n.length; A++) v += Math.abs(n[A].y), !a && ("undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[A].label && null !== n[A].label && 0 < n[A].label.toString().length) && (a = !0);
            if (0 !== v) {
                ...
                var E = "undefined" !== typeof m.innerRadius && null !== m.innerRadius ? Oa(m.innerRadius, B) : 0.7 * B;
                m.radius = B;
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                    ...
                    for (b = 0; b < n.length; b++) {
                        ...
                        d > c && Ha(l.plotArea.ctx, r[b].center, r[b].radius, g, m.type, c, d, m.fillOpacity, r[b].percentInnerRadius);
                        if (f) break
                    }
                    k()
                }, function() {
    ...
    ia.prototype.registerSpace = function(a, d) {
    ...
    ia.prototype.unRegisterSpace = function(a, d) {
    ...
    W.prototype._wrapText = function() {
        var a = new String(la(String(this.text))),
            d = [],
            b = this.ctx.font,
            c = 0,
            f = 0;
        for (this.ctx.font = this._getFontString(); 0 < a.length;) {
            ...
            var k = f,
                ...
                c = c + h.height,
                a = la(a.slice(h.text.length, a.length));
            g && c > g && (h = d.pop(), c -= h.height, f = k)
        }
        this._wrappedText = {
            lines: d,
            width: f,
    ...
    U(wa, M);
    wa.prototype.render = na.prototype.render;
    U(xa, M);
    xa.prototype.render = function() {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
            ...
            g = 0,
            h = 0,
            k = this.markerMargin = this.chart.options.legend && !x(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin :
            0.3 * this.fontSize;
        this.height = 0;
        var l = [],
            m = [];
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                ...
                for (var v = 0; v < p.dataPoints.length; v++) {
                    var t = p.dataPoints[v],
                        ...
                        q =
                        t.legendMarkerColor ? t.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : t.color ? t.color : p.color ? p.color : p._colorSet[v % p._colorSet.length],
                    ...
                    (t.showInLegend || p.showInLegend && !1 !== t.showInLegend) && l.push(e)
                }
            ...
            for (n = 0; n < l.length; n++) {
                ...
                if (!(0 >= h || "undefined" === typeof h || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!p || p.width + Math.round(e.textBlock.width + s + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p = {
                            items: [],
                            width: 0
                        }, m.push(p), this.height += v, v = 0;
                        ...
                        fontStyle: this.fontStyle,
                        textBaseline: "middle"
                    }), e.textBlock.measureText(), null !== this.itemWidth && (e.textBlock.width = this.itemWidth - (s + k + ("line" === e.chartType || "spline" === e.chartType ||
                    ...
                    e.textBlock.y = 0;
                    p.width += Math.round(e.textBlock.width + s + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0));
                    p.items.push(e);
                    this.width = Math.max(p.width, this.width);
                    q = e.textBlock.width + (s + k + ("line" === e.chartType || "spline" ===
        ...
        this.items = l;
        for (n = 0; n < this.items.length; n++) e = l[n], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = {
            id: e.id,
        ...
        for (n = d = 0; n < m.length; n++) {
            ...
            for (t = v = 0; t < p.items.length; t++) {
                ...
                if ("line" === e.chartType || "stepLine" === e.chartType || "spline" ===
                    e.chartType) this.ctx.strokeStyle = e.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(q - 0.1 * this.lineHeight, u + this.lineHeight / 2), this.ctx.lineTo(q + 0.85 * this.lineHeight, u + this.lineHeight / 2), this.ctx.stroke(), r -= 0.1 * this.lineHeight;
                P.drawMarker(q + s / 2, u + this.lineHeight / 2, this.ctx, e.markerType, e.markerSize, e.markerColor, e.markerBorderColor, e.markerBorderThickness);
                e.textBlock.x = q + k + s;
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "doughnut":
                            ...
                            q < e.radius &&
                                q > u && (q = Math.atan2(d - s.y, a - s.x), 0 > q && (q += 2 * Math.PI), q = Number(((180 * (q / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (e.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), u = Number(((180 * (e.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < e.endAngle && (u = 360), s >= u && 0 !== r.y && (u += 360, q < s && (q += 360)), q > s && q < u && (c.push({
                                    dataPoint: r,
                                    dataPointIndex: g,
                                    dataSeries: this,
                                    distance: 0
    ...
    B.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            ...
            }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : Fa(b, this.valueFormatString, this.chart._cultureInfo), a = new W(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: g,
            ...
            if (this.labels) {
                a = Math.ceil(k);
                for (var k = Math.ceil(this.intervalStartPosition), p = !1, b = k; b < this.viewportMaximum; b += a)
                    if (this.labels[b]) p = !0;
                    else {
                        p = !1;
                        break
                    }
                p && (this.interval = a, this.intervalStartPosition = k)
            }
            if (this.logarithmic && !this.equidistantInterval) {
                ...
                for (var e = 0; e < this.logLabelValues.length; e++) b = this.logLabelValues[e], b < this.viewportMinimum || (a = this.labelFormatter ? this.labelFormatter({
                    ...
                    value: b,
                    label: this.labels[b] ? this.labels[b] : null
                }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : ca(b, this.valueFormatString, this.chart._cultureInfo), a = new W(this.ctx, {
                    x: 0,
                    y: 0,
                    maxWidth: g,
                    maxHeight: h,
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)
            if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle %
                ...
                if (g = 0.9 * l >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        if (a = this._labels[b].textBlock, r = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock, d = d.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
                            ...
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((c - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), c), s = (n - (m + a.fontSize / 2) *
                                ...
                                if (x(this.options.labelWrap))
                                    ...
                                    if (c = r.width + d.width >> 0, e = this.labelFontSize, p < g) c - 2 * g > k && (k = c - 2 * g, c >= 2 * g && c < 2.2 * g ? (this.sessionVariables.labelMaxWidth =
                                    ...
                                    else if (q === b && (0 === q && p + this._labels[q + 1].textBlock.measureText().width - 2 * g > k || q === this._labels.length - 1 && p + this._labels[q -
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === g.labelPlacement) {
                ...
                if ("bottom" === this._position || "top" === this._position) u = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
    ...
    B.setLayoutAndRender = function(a, d, b, c, f, g) {
        var h, k, l, m, n = a[0] ? a[0].chart : d[0].chart,
            p = n.ctx;
        if (a && 0 < a.length)
        ...
        if ("normal" === f) {
            ...
            for (; 4 > r;) {
                var N = 0,
                    ...
                    T = 0;
                if (b && 0 < b.length)
                    for (v = [], e = U = 0; e < b.length; e++) v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), U += v[e], C += b[e] ? b[e].margin : 0;
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, k = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - X - f - C), b[e].lineCoordinates = {
                        x1: l - P,
                        y1: k,
                        x2: l - P,
                        y2: m,
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), l = Math.round(h), C = c[e]._labels && 0 < c[e]._labels.length ? c[e]._labels[c[e]._labels.length - 1].textBlock.height / 2 : 0, k = Math.round(g.y1 + V + L < Math.max(C,
            ...
            for (; 4 > r;) {
                ...
                M.push(q);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) b[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), l = Math.round(g.x2 - V - L > n.width - 10 ? n.width - 10 : g.x2 - V - L), b[e].labelAutoFit && !x(u) && (0 < !a.length && (h = 0 > b[e].labelAngle ? Math.max(h, u) : 0 === b[e].labelAngle ? Math.max(h, u / 2) : h), 0 < !d.length && (l = 0 < b[e].labelAngle ? l - w / 2 : 0 === b[e].labelAngle ?
                        l - w / 2 : l)), b[e].lineCoordinates.x1 = h, b[e].lineCoordinates.x2 = l, b[e].lineCoordinates.width = Math.abs(l - h), b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.width ? b[e].titleMaxWidth : b[e].lineCoordinates.width);
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e].lineCoordinates = {}, h = Math.round(g.x1 + X + f), l = Math.round(g.x2 - V - L > c[e].chart.width - 10 ? c[e].chart.width - 10 : g.x2 - V - L), c[e] && c[e].labelAutoFit && !x(v) && (0 < !a.length && (h = 0 < c[e].labelAngle ? Math.max(h, v) :
                        0 === c[e].labelAngle ? Math.max(h, v / 2) : h), 0 < !d.length && (l -= t / 2)), c[e].lineCoordinates.x1 = h, c[e].lineCoordinates.x2 = l, c[e].lineCoordinates.width = Math.abs(l - h), c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width);
                if (b && 0 < b.length)
                ...
                H.push(A);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) 0 < b[e]._labels.length && (m = b[e]._labels[0], k = b[e]._labels[b[e]._labels.length - 1], u = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                        w = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)));
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e] && 0 < c[e]._labels.length && (m = c[e]._labels[0], k = c[e]._labels[c[e]._labels.length - 1], v = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), t = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) +
                        (k.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)));
                if (n.panEnabled)
                    for (e = 0; e < b.length; e++) z[e] = n.sessionVariables.axisY.height;
                else
                    for (e = 0; e < b.length; e++) n.sessionVariables.axisY.height = z[e];
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--) k = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = k - (z[e] + b[e].margin + N), b[e].lineCoordinates.y2 = k - (z[e] + b[e].margin + N), b[e].bounds = {
                        x1: h,
                        y1: k - (z[e] + N + b[e].margin),
                        x2: l,
                        y2: m - (N + b[e].margin),
                        width: l - h,
                        height: z[e]
                ...
                if (c && 0 < c.length)
                    for (e = c.length - 1; 0 <= e; e--) c[e] && (k = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + c[e].margin + Q)), c[e].lineCoordinates.y1 = m, c[e].lineCoordinates.y2 = m, c[e].bounds = {
                        x1: h,
                        y1: k + (c[e].margin + Q),
                        x2: l,
                        y2: m,
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        h = Math.round(g.x1 + f);
                        k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y2 : g.y1 < Math.max(C, 10) ? Math.max(C, 10) : g.y1) : g.y1 < Math.max(C, 10) ? Math.max(C, 10) : g.y1;
                        ...
                        if (b && 0 < b.length)
                            for (C = 0; C < b.length; C++) b[C] && b[C].labelAutoFit && (l = 0 > b[C].labelAngle ? Math.max(l, u) : 0 === b[C].labelAngle ? Math.max(l, u / 2) : l, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? l - X : h);
                        if (c && 0 < c.length)
                            for (C = 0; C < c.length; C++) c[C] && c[C].labelAutoFit && (l = c[C].lineCoordinates.x1, h = l - X);
                        a[e].lineCoordinates = {
                            x1: l - K,
                            y1: k,
                            x2: l - K,
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) {
                        ...
                        h = Math.round(g.x1 - f);
                        k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y2 : g.y1 < Math.max(C, 10) ? Math.max(C, 10) : g.y1) : g.y1 < Math.max(C, 10) ? Math.max(C,
                            10) : g.y1;
                        l = Math.round(g.x2 - V - L);
                        ...
                        if (b && 0 < b.length)
                            for (C = 0; C < b.length; C++) b[C] && b[C].labelAutoFit && (l = 0 > b[C].labelAngle ? Math.max(l, u) : 0 === b[e].labelAngle ? Math.max(l, u / 2) : l, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? l - V : h);
                        if (c && 0 < c.length)
                            for (C = 0; C < c.length; C++) c[C] && c[C].labelAutoFit && (l = c[C].lineCoordinates.x2, h = l - V);
                        d[e].lineCoordinates = {
                            x1: l + P,
                            y1: k,
                            x2: l + P,
            ...
            if ("bottom" === this._position || "top" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var d = [], c = 0 !== this.labelAngle &&
                            360 !== this.labelAngle ? 1 : 1.2, g, h = this.viewportMaximum, k = this.lineCoordinates.width / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        n = this._labels[l];
                        if (n.position < this.viewportMinimum) break;
                        n.position > this.viewportMaximum || !(l === this._labels.length - 1 || g < Math.log(h / n.position) * k / c) || (d.push(n), h = n.position, g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = d
                } else {
                    for (l = 0; l < this._labels.length; l++) n =
                        this._labels[l], n.position < this.viewportMinimum || (n = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), d += n);
                    d > this.lineCoordinates.width * c && this.labelAutoFit && (a = !0)
                }
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var d = [], m, h = this.viewportMaximum, k = this.lineCoordinates.height / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        n = this._labels[l];
                        if (n.position < this.viewportMinimum) break;
                        n.position > this.viewportMaximum || !(l === this._labels.length - 1 || m < Math.log(h / n.position) * k) || (d.push(n), h = n.position, m = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = d
                } else {
                    for (l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || (n = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI /
                        180 * this.labelAngle)), b += n);
                    b > this.lineCoordinates.height * c && this.labelAutoFit && (a = !0)
                }
        }
        if ("bottom" === this._position) {
            for (var n, l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, c = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, this.ctx.beginPath(), this.ctx.moveTo(c,
            ...
            for (l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle =
            ...
            for (l = 0; l < this._labels.length; l++) n = this._labels[l], n.position < this.viewportMinimum || n.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(n.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, c = 1 === this.ctx.lineWidth %
    ...
    B.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var d = this, b, c = 0, f = 0, g = !1, h = !1, k = [], l = [], h = !1, c = 0; c < this.stripLines.length; c++) {
                var m = this.stripLines[c];
                m._thicknessType === a && ("pixel" === a && (m.value < this.viewportMinimum ||
                    m.value > this.viewportMaximum || x(m.value) || isNaN(this.range)) || k.push(m))
            }
            ...
            if (!h) {
                ...
                this.ctx.clip();
                for (c = 0; c < k.length; c++) m = k[c], m.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                    this.ctx.save();
                    this.ctx.beginPath();
                ...
                for (c = 0; c < l.length; c++) b = l[c], b.stripLine.showOnTop ?
                    h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        for (f = 0; f < l.length; f++) b = l[f], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), b.textBlock.render(!0), d.ctx.restore())
                    }, b.textBlock)) : "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0);
                this.ctx.restore();
                h = !0
            }
            if (h)
                for (h = !1, c = 0; c < l.length; c++) b = l[c], b.stripLine.showOnTop ?
                    h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
    ...
    U(oa, M);
    oa.prototype.createUserOptions = function(a) {
        if ("undefined" !== typeof a || this.options._isPlaceholder) {
            var d = 0;
            this.parent.options._isPlaceholder && this.parent.createUserOptions();
            this.options._isPlaceholder || (ra(this.parent.stripLines), d = this.parent.options.stripLines.indexOf(this.options));
            this.options = "undefined" === typeof a ? {} : a;
    ...
    oa.prototype.render = function() {
        ...
        if (0 < d) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) f =
                g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = {
                    x1: f - d / 2,
                    y1: h,
                    x2: g + d / 2,
                    y2: k
    ...
    S.prototype._updateToolTip = function(a, d, b) {
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var k =
                            ...
                            for (var h = this.chart.axisX[k].convertPixelToValue({
                                    y: d
                                }), l = null, c = 0; c < this.chart.axisX[k].dataSeries.length; c++)(l = this.chart.axisX[k].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[k].dataSeries[c], null !== l.dataPoint.y && f.push(l));
                            l = null
                        }
                    if (this.chart.axisX2)
                        for (k = 0; k < this.chart.axisX2.length; k++) {
                            h = this.chart.axisX2[k].convertPixelToValue({
                                y: d
                            });
                            l = null;
                            for (c = 0; c < this.chart.axisX2[k].dataSeries.length; c++)(l = this.chart.axisX2[k].dataSeries[c].getDataPointAtX(h,
                                b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[k].dataSeries[c], null !== l.dataPoint.y && f.push(l));
                            l = null
                        }
                } else {
                    f = [];
                        ...
                        for (k = 0; k < this.chart.axisX2.length; k++)
                            for (h =
                                this.chart.axisX2[k].convertPixelToValue({
                                    x: a
                                }), l = null, c = 0; c < this.chart.axisX2[k].dataSeries.length; c++)(l = this.chart.axisX2[k].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[k].dataSeries[c], null !== l.dataPoint.y && f.push(l))
                }
                ...
                if (l = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex =
                    l.dataPointIndex, this.currentSeriesIndex = l.dataSeries.index;
                else if (v)
                    if (l = Ma(a, d, this.chart._eventManager.ghostCtx), 0 < l && "undefined" !== typeof this.chart._eventManager.objectMap[l]) {
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    l = {};
                    if (0 <= this.currentDataPointIndex) c = f.dataPoints[this.currentDataPointIndex], l.dataSeries = f, l.dataPoint = c, l.index = this.currentDataPointIndex, l.distance = Math.abs(c.x - h);
                    else {
            ...
            if (0 < g.length && (this.highlightObjects(g),
                ...
                if (b = "", b = this.getToolTipInnerHTML({
                    ...
                    try {
                        this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor : v ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", this.borderColor = this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.options.borderColor ? this.options.borderColor :
    ...
    S.prototype.getToolTipInnerHTML = function(a) {
        var d = a.entries,
            ...
            g = 0;
        a = "";
        for (var h = !0, k = 0; k < d.length; k++)
            if (d[k].dataSeries.toolTipContent || d[k].dataPoint.toolTipContent) {
                h = !1;
                break
            }
        if (h && (this.content && "function" === typeof this.content ||
            ...
            for (var l = null, m = "", k = 0; k < d.length; k++)
                if (c = d[k].dataSeries, f = d[k].dataPoint, g = d[k].index, a = "", 0 === k && (h && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? m += "undefined" !== typeof this.chart.axisX[0].labels[f.x] ? this.chart.axisX[0].labels[f.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length &&
                    ...
                    if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" ===
                        c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type) this.chart.axisX && 1 < this.chart.axisX.length && (a += l != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), a += f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}", l = c.axisXIndex;
                    else if ("bubble" === c.type) this.chart.axisX &&
                        1 < this.chart.axisX.length && (a += l != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), a += f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
                        ...
                        (a += l != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), a += f.toolTipContent ? f.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
                    else if ("candlestick" === c.type || "ohlc" === c.type) this.chart.axisX && 1 < this.chart.axisX.length && (a += l != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" :
                    ...
                    null === b && (b = "");
                    !0 === this.reversed ? (b = this.chart.replaceKeywordsWithValue(a, f, c, g) + b, k < d.length - 1 && (b = "</br>" + b)) : (b += this.chart.replaceKeywordsWithValue(a,
                        f, c, g), k < d.length - 1 && (b += "</br>"));
                    c.toolTipContent = a
                }
            null !== b && (b = m + b)
        } else {
    ...
    A.prototype.replaceKeywordsWithValue = function(a, d, b, c, f) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            if ("x" === a)
                ...
                } else return ca(h, d.xValueFormatString ? d.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo);
            else return "y" === a ? ca(h, d.yValueFormatString ? d.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########",
                g._cultureInfo) : "z" === a ? ca(h, d.zValueFormatString ? d.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", g._cultureInfo) : h
        })
    };
    ...
    ma.prototype.getNewObjectTrackingId = function() {
        return ++this.lastObjectId
    };
    ma.prototype.mouseEventHandler = function(a) {
    ...
    ma.prototype.fireEvent = function(a, d, b) {
        if (a && d) {
    ...
    var F = {
        ...
        P = {
            drawMarker: function(a, d, b, c, f, g, h, k) {
                if (b) {
                    var l = 1;
                    b.fillStyle = g ? g : "#000000";
                    b.strokeStyle = h ? h : "#000000";
                    b.lineWidth = k ? k : 0;
                    "circle" === c ? (b.moveTo(a, d), b.beginPath(), b.arc(a, d, f / 2, 0, 2 * Math.PI, !1), g && b.fill(), k && (h ? b.stroke() : (l = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = l))) :
        ...
        ka = {
            ...
            formatNumber: function(a, d, b) {
                b = b || "en";
                if (qa[b]) return ca(a, d || "#,##0.##", new pa(b));
                throw "Unknown Culture Name";
            },
            formatDate: function(a, d, b) {
                b = b || "en";
                if (qa[b]) return Fa(a, d ||
                    "DD MMM YYYY", new pa(b));
                throw "Unknown Culture Name";
            }
        };
    ka.Chart.version = "v1.9.8 GA";
    window.CanvasJS = ka
})();
/*
