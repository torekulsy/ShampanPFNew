...
namespace SymWebUI.Files.ReportFiles.PF {
    ...
    public class rptInvestmentStatement : ReportClass {
        
        public rptInvestmentStatement() {
        }
        
        public override string ResourceName {
            get {
                return "rptInvestmentStatement.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.PF.rptInvestmentStatement.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptInvestmentStatement : Component, ICachedReport {
        
        public CachedrptInvestmentStatement() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptInvestmentStatement rpt = new rptInvestmentStatement();
            rpt.Site = this.Site;
            return rpt;
        }
