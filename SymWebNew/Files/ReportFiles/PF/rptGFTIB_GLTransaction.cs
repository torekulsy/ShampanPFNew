...
namespace SymWebUI.Files.ReportFiles.PF {
    ...
    public class rptGFTIB_GLTransaction : ReportClass {
        
        public rptGFTIB_GLTransaction() {
        }
        
        public override string ResourceName {
            get {
                return "rptGFTIB_GLTransaction.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.PF.rptGFTIB_GLTransaction.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptGFTIB_GLTransaction : Component, ICachedReport {
        
        public CachedrptGFTIB_GLTransaction() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptGFTIB_GLTransaction rpt = new rptGFTIB_GLTransaction();
            rpt.Site = this.Site;
            return rpt;
        }
