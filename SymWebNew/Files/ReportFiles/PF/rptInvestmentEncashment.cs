...
namespace SymWebUI.Files.ReportFiles.PF {
    ...
    public class rptInvestmentEncashment : ReportClass {
        
        public rptInvestmentEncashment() {
        }
        
        public override string ResourceName {
            get {
                return "rptInvestmentEncashment.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.PF.rptInvestmentEncashment.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptInvestmentEncashment : Component, ICachedReport {
        
        public CachedrptInvestmentEncashment() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptInvestmentEncashment rpt = new rptInvestmentEncashment();
            rpt.Site = this.Site;
            return rpt;
        }
