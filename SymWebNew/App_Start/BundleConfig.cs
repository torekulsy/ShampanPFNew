...
namespace SymWebUI
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/customjqueryui").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/themes/base/css").Include(
                    ...
                    "~/Content/themes/base/jquery.ui.theme.css"));
            bundles.Add(new StyleBundle("~/bundles/pharmaraw/css").Include(
                  "~/assets/css/demo_table.css",
                  "~/assets/css/demo_table_jui.css",
                  "~/assets/css/menu.css",
                  "~/assets/css/jquery-ui.css",
                  "~/assets/plugins/bootstrap/css/bootstrap.min.css",
                  "~/assets/plugins/font-awesome/css/font-awesome.css",
                  "~/assets/stylesheets/common.css",
                  "~/assets/css/jquery.ptTimeSelect.css"));
        }
    }
}