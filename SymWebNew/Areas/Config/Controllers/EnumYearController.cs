...
{
    [Authorize]
    public class EnumYearController : Controller
    {
        //
        // GET: /Enum/EnumYear/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumYearRepo _repo = new EnumYearRepo();
        #region Actions

        /// <summary>
        /// Created: 10 Feb 2025  
        /// Created By: Md Torekul Islam  
        /// Retrieves all Enum Year information.
        /// </summary>      
        /// <returns>View containing Enam Year</returns>
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumYearVM> filteredData;
            ...
            Func<EnumYearVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
            ...
            var result = from c in displayedCompanies 
                         select new[] { 
                             ...
                             , c.Name, Convert.ToString(c.IsActive == true ? "Active" : "Inactive") 
                             , c.Remarks 
                         };
            return Json(new
            {
        ...
        /// </remarks>
        [HttpPost]
        public ActionResult Create(EnumYearVM vm)
        {
        ...
        /// <summary>
        /// Handles the HTTP GET request to load the edit view for a specific department.
        /// Checks user permission and retrieves Bank EnumYear by ID.
        /// </summary>
        /// <param name="id">The ID of the EnumYear to be edited.</param>
        /// <returns>
        /// A <see cref="PartialViewResult"/> containing the <see cref="EnumYearVM"/> to populate the edit form.
        /// </returns>
        [HttpPost]
        public ActionResult Edit(EnumYearVM vm, string btn)
        {
