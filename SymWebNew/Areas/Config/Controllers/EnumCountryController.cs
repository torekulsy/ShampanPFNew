...
{
    public class EnumCountryController : Controller
    {      
        // GET: /Enum/EnumCountry/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumCountryRepo _repo = new EnumCountryRepo();
        #region Actions
        ...
        /// Retrieves all Enum Country information.
        /// </summary>      
        /// <returns>View containing Enam Country</returns>
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            var getAllData = _repo.SelectAll();
            IEnumerable<EnumCountryVM> filteredData;
            ...
            Func<EnumCountryVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        /// </remarks>
        [HttpPost]
        public ActionResult Create(EnumCountryVM vm)
        {
        ...
        /// Checks user permission and retrieves EnumContry data by ID.
        /// </summary>
        /// <param name="id">The ID of the EnumContry to be edited.</param>
        /// <returns>
        /// A <see cref="PartialViewResult"/> containing the <see cref="EnumContryVM"/> to populate the edit form.
        /// </returns>
        [HttpGet]
        ...
        [HttpPost]
        public ActionResult Edit(EnumCountryVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
