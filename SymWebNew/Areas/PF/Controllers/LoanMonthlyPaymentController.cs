...
namespace SymWebUI.Areas.PF.Controllers
{
    public class LoanMonthlyPaymentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/PF/Views/LoanMonthlyPayment/Index.cshtml",vm);
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/PF/Views/LoanMonthlyPayment/Create.cshtml", vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                dt.TableName = "dtLoan";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\PF\\rptLoanMonthlyPayment.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/PF/Views/LoanMonthlyPayment/reportVeiw.cshtml", vm);
