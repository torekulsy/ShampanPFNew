...
namespace SymWebUI.Areas.PF.Controllers
{
    public class LoanSattlementController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/PF/Views/LoanSattlement/Index.cshtml",vm);
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/PF/Views/LoanSattlement/Create.cshtml", vm);
        }
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                dt.TableName = "dtLoan";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\PF\\rptLoanSattlement.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypePFVM.TransType;
                return PartialView("~/Areas/PF/Views/LoanSattlement/reportVeiw.cshtml", vm);
