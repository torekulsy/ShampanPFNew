...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class BankNameController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/BankName/Index.cshtml");
        }
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            var getAllData = _repo.SelectAll(0, new string[] { "TransType", "BranchId" }, new string[] { AreaTypeWPPFVM.TransType, BranchId });
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return PartialView("~/Areas/WPPF/Views/BankName/Create.cshtml", vm);
        }
