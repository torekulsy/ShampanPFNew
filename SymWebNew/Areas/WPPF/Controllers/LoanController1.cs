...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class LoanController1 : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/Loan/Index.cshtml",vm);
        }
        public ActionResult _index(JQueryDataTableParamVM param)
        {
            ...
            IEnumerable<LoanVM> filteredData;
            ...
            Func<LoanVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Code :
        ...
        public ActionResult Create()
        {
            ...
            return View("~/Areas/WPPF/Views/Loan/Create.cshtml" ,vm);

        }

        [HttpPost]
        public ActionResult CreateEdit(LoanVM vm)
        {
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptLoan.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                PFReport report = new PFReport();
                Loanvm = _repo.SelectAll(Convert.ToInt32(id)).FirstOrDefault();
                vm.Id = id;
                vm.Code = Loanvm.Code;
                vm.TransType = AreaTypeWPPFVM.TransType;
                return PartialView( "~/Areas/WPPF/Views/Loan/reportVeiw.cshtml", vm);
            }
            catch (Exception)
            {
                throw;
        ...
        [HttpPost]
        public ActionResult LoanReport(PFReportVM vm)
        {
            try
            {
                string ReportHead = "";
