...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class InvestmentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/Investment/Index.cshtml");
        }
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            var getAllData = _repo.SelectAll(0, new string[] { "inv.TransType", "ina.BranchId" }, new string[] { AreaTypeWPPFVM.TransType, Session["BranchId"].ToString() });
        ...
        public ActionResult Create(InvestmentVM vm)
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/Investment/Create.cshtml", vm);
        }
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/WPPF/Views/Investment/Report.cshtml");
        }
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptInvestmentNew.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                Investmentvm.TransType = AreaTypeWPPFVM.TransType;
                PFReport report = new PFReport();
                Investmentvm = _repo.SelectAll(Convert.ToInt32(id)).FirstOrDefault();
                vm.Id = id;
                vm.Code = Investmentvm.TransactionCode;
                return PartialView("~/Areas/WPPF/Views/Investment/reportVeiw.cshtml", vm);
        ...
        public ActionResult Investment_GLTransactionReport(PFReportVM vm)
        {
            ...
            try
            {
                ...
                Withdrawvm.TransType = AreaTypeWPPFVM.TransType;
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptInvestment.rpt";
        ...
        public ActionResult Investment_DetailsReport(PFReportVM vm)
        {
            ...
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptInvestmentDetails.rpt";
        ...
        public ActionResult InvestmentReport(PFReportVM vm)
        {
         ...
         /// </summary>
         /// <param name="Id">The identifier used to filter data for the WPPF Contribution report.</param>
         /// <returns>A PDF file as an ActionResult containing the WPPF Contribution Report.</returns>
        [HttpGet]
        public ActionResult PFContributionReport(string Id)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptPFContribution.rpt";
