...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class ProfitDistributionController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/ProfitDistribution/Index.cshtml");
        }
        ...
        public ActionResult IndexPreDistributionFund()
        {
            ...
            return View("~/Areas/WPPF/Views/ProfitDistribution/IndexPreDistributionFund.cshtml");
        ...
        public ActionResult Create(ProfitDistributionVM vm)
        {
            ...
            return View("~/Areas/WPPF/Views/ProfitDistribution/Create.cshtml",vm);
