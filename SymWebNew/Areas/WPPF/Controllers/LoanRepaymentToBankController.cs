...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class LoanRepaymentToBankController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/LoanRepaymentToBank/Index.cshtml",vm);
        ...
        public ActionResult Create()
        {
            ...
            vm.TransType = AreaTypeWPPFVM.TransType;
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/LoanRepaymentToBank/Create.cshtml",vm);
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                dt.TableName = "dtLoan";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptLoanRepaymentToBank.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypeWPPFVM.TransType;
                return PartialView("~/Areas/WPPF/Views/LoanRepaymentToBank/reportVeiw.cshtml", vm);
            }
            catch (Exception)
            {
                throw;
