...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class JournalController : Controller
    {
        ...
        public ActionResult Index(string JournalType = "1")
        {
            ...
            return View("~/Areas/WPPF/Views/Journal/Index.cshtml",vm);
        ...
        public ActionResult Create(string JournalType, string TransactionForm,string TransactionId)
        {
            ...
            var getAllData = _JournalTypeRepo.SelectAllJournalTransactionType(0, new[] { "NameTrim", "TransType" }, new[] { TransactionForm, AreaTypeWPPFVM.TransType });
            ...
            GLJournalVM vm = new GLJournalVM
            {
                ...
                TransType=AreaTypeWPPFVM.TransType

            };
            return View("~/Areas/WPPF/Views/Journal/Create.cshtml", vm);
        ...
        /// </summary>      
        /// <returns>View containing WPPF Journal</returns>
        ...
        public ActionResult CreateEdit(GLJournalVM vm)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/WPPF/Views/Journal/Create.cshtml", vm);
            }
            catch (Exception)
            {
        ...
        public ActionResult Edit(string id)
        {
            ...
            catch (Exception e)
            {
                ...
                return View("~/Areas/WPPF/Views/Journal/Create.cshtml", new GLJournalVM());
        ...
        public ActionResult BlankItem(GLJournalDetailVM vm)
        {
            ...
            try
            {
                ...
                vm.TransType = AreaTypeWPPFVM.TransType;
                return PartialView("~/Areas/WPPF/Views/Journal/_details.cshtml", vm);
        ...
        public ActionResult ReportView(string id)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptTIB_GLTransaction.rpt";
