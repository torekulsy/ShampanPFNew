...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class EmployeeBreakMonthPFController : Controller
    {
        ...
        //D:\HRM\ShampanHRM\SymWebNew\Areas\WPPF\Controllers\EmployeeBreakMonthPFController.cs
        // GET: /WPPF/EmployeeBreakMonthPF/
        ...
        public ActionResult Create(EmployeeInfoVM empVM)
        {
            ...
            try
            {
                ...
                ////return Redirect("/WPPF/EmployeeBreakMonthPF/SingleEmployeeBreakMonthPFEdit?PFOpeinigId=" + result[2].ToString());
        ...
        public ActionResult MultiplePost(string ids)
        {
            ...
            var EmployeeBreakMonthPFVM = _eaRepo.SelectByIdAll(strId[0]);
            if (EmployeeBreakMonthPFVM != null)
            {
                if (EmployeeBreakMonthPFVM.Post == true)
                {
        ...
        public ActionResult ReportView(int id)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ReportHead = "WPPF Employee BreakMonth Transactions";
                }
                dt.TableName = "dtEmployeeForfeiture";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptPFEmployeeBreakMonth.rpt";
