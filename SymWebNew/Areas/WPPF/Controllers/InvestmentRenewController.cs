...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class InvestmentRenewController : Controller
    {
        ...
        public ActionResult Index(int investmentId = 0)
        {
            ...
            return View("~/Areas/WPPF/Views/InvestmentRenew/Index.cshtml",investmentRenewVm);
        }
        public ActionResult _index(JQueryDataTableParamModel param, int investmentId = 0)
        {
            ...
            var getAllData = _repo.SelectAll(0, new[] { "inv.InvestmentId", "inv.TransType" }, new[] { investmentId.ToString(), AreaTypeWPPFVM.TransType });
        ...
        public ActionResult Create(int investmentId = 0, string Encash = "F")
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/InvestmentRenew/Create.cshtml", vm);
        ...
        public ActionResult InvestmentRenew(PFReportVM vm)
        {
            try
            {
                ...
                if (vm.ReportType == "InvestmentRenew")
                {
                    ...
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptPFInvestmentRenew1.rpt";
                }
                else
                {
                    ...
                    Reportvm.TransType = AreaTypeWPPFVM.TransType;
                    ...
                    dt.TableName = "dtInvestmentRenew";
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptInvestmentEncashment.rpt";
                }
    ...
    public ActionResult ReportView(int id)
    {
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypeWPPFVM.TransType;
                return PartialView("~/Areas/WPPF/Views/InvestmentRenew/reportVeiw.cshtml", vm);
        ...
        public ActionResult Withdraw_GLTransactionReport(PFReportVM vm)
        {
            ...
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptWithdraw.rpt";
