...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class ReturnOnBankInterestController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/ReturnOnBankInterest/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/ReturnOnBankInterest/Create.cshtml",vm);
        }
        [Authorize(Roles = "Admin")]
        [HttpPost]
        ...
        public ActionResult Detail(string id)
        {
            ...
            vm.TransType = AreaTypeWPPFVM.TransType;
            vm = _repo.SelectAll(Convert.ToInt32(id)).FirstOrDefault();
            return View("~/Areas/WPPF/Views/ReturnOnBankInterest/Detail.cshtml", vm);
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/WPPF/Views/ReturnOnBankInterest/Report.cshtml");
        ...
        //        rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptReturnOnBankInterest.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                return PartialView("~/Areas/WPPF/Views/ReturnOnBankInterest/reportVeiw.cshtml", vm);
