...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class BankBranchController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/BankBranch/Index.cshtml");
        }
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            var getAllData = _repo.SelectAll(0, new string[] { "bb.TransType", "b.BranchId" }, new string[] { AreaTypeWPPFVM.TransType, Session["BranchId"].ToString() });
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/BankBranch/Create.cshtml", vm);
        }
