...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class COAGroupController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/COAGroup/Index.cshtml");
        }
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            var getAllData = _repo.SelectAll(0, new[] { "COAGroups.TransType" }, new[] { AreaTypeWPPFVM.TransType });
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/COAGroup/Create.cshtml", vm);
        }
