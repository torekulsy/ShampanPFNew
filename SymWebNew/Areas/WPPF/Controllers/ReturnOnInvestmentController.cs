...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class ReturnOnInvestmentController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/ReturnOnInvestment/Index.cshtml");
        }
        ...
        public ActionResult Create(ReturnOnInvestmentVM vm)
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/ReturnOnInvestment/Create.cshtml",vm);
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/WPPF/Views/ReturnOnInvestment/Report.cshtml");
        }
        [HttpGet]
