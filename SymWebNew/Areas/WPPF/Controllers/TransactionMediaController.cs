...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class TransactionMediaController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/TransactionMedia/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return PartialView("~/Areas/WPPF/Views/TransactionMedia/Create.cshtml", vm);
        }
