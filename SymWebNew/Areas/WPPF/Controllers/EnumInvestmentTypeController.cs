...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class EnumInvestmentTypeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/EnumInvestmentType/Index.cshtml");
        }
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return PartialView("~/Areas/WPPF/Views/EnumInvestmentType/Create.cshtml", vm);
        }
