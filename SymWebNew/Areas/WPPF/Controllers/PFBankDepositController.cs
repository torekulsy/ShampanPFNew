...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class PFBankDepositController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/PFBankDeposit/Index.cshtml");
        }
        ...
        /// </summary>      
        /// <returns>View containing WPPF Bank Deposit</returns>
        ...
        public ActionResult Create(PFBankDepositVM vm)////string tType = "")
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/PFBankDeposit/Create.cshtml",vm);
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/WPPF/Views/PFBankDeposit/Report.cshtml");
        }
        ...
        public ActionResult ReportView(int id)
        {
            ...
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\\rptBankDeposit.rpt";
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                vm.TransType = AreaTypeWPPFVM.TransType;
                return PartialView("~/Areas/WPPF/Views/PFBankDeposit/reportVeiw.cshtml", vm);
