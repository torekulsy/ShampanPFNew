...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class WithdrawController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("~/Areas/WPPF/Views/Withdraw/Index.cshtml");
        ...
        public ActionResult Create()
        {
            ...
            vm.Operation = "add";
            return View("~/Areas/WPPF/Views/Withdraw/Create.cshtml",vm);
        }
        ...
        public ActionResult Report()
        {
            ...
            return View("~/Areas/WPPF/Views/Withdraw/Report.cshtml");
        }
        ...
        public ActionResult reportVeiw(int id)
        {
            try
            {
                ...
                return PartialView("~/Areas/WPPF/Views/Withdraw/reportVeiw.cshtml", vm);
