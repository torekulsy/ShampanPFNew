...
namespace SymWebUI.Areas.WPPF.Controllers
{
    public class LoanController : Controller
    {
        ...
        /// Retrieves all WPPF Loan information.
        /// </summary>      
        /// <returns>View containing WPPF Loan</returns>
        ...
        public ActionResult Create(EmployeeLoanVM vm)
        {
            ...
            try
            {
                ...
                var amount = vm.PrincipalAmount.Value / vm.NumberOfInstallment.Value;
                ...
                var totalCount = vm.NumberOfInstallment.Value - 1;
        ...
        /// Created: 10 Feb 2025  
        /// Created By: Md Torekul Islam  
        /// Retrieves all Employee Information for WPPF Loan.
        /// </summary>      
        /// <returns>View containing Employee Information for WPPF Loan</returns>
        [Authorize]
        ...
        public ActionResult ScheduleofLoanMember(string ProjectId, string DepartmentId, string SectionId, string DesignationId, string CodeF, string CodeT, string view,string FromDate,string ToDate)
        {
            try
            {
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\rptLoanStatement.rpt";
                ...
                ds.Tables.Add(table);
                ds.Tables[0].TableName = "dtEmpLoan";
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\rptScheduleofLoanMember.rpt";
        ...
        public ActionResult EmployeeLoanStatementReport(string ProjectId, string DepartmentId, string SectionId, string DesignationId, string CodeF, string CodeT, string view, string Rtype, string DateFrom, string DateTo)
        {
            try
            {
                ...
                if (Rtype == "Summary")
                {
                    ...
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\rptAllLoanSummary.rpt";
                ...
                if (Rtype == "Individual")
                {
                    ...
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\rptLoanEGCB_Individual.rpt";
                ...
                if (Rtype == "Statement")
                {
                    ...
                    rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\rptAllLoanStatement.rpt";
                    ReportHead = "There are no data to Preview for Loan Statement";
                    if (getAllData.Count > 0)
                    {
                        DateTime startdatte = DateTime.Now;
        ...
        /// <summary>
        /// Retrieves the Provident Fund (WPPF) loan balance and applicable interest rates 
        ...
        /// </summary>
        /// <param name="ApplicationDate">The date for which the WPPF balance should be calculated. If null or empty, the current date is used.</param>
        /// <param name="emploanId">The unique identifier of the employee loan.</param>
        /// <returns>A JSON object containing WPPF balance, interest rate details, and rate settings.</returns>        [HttpGet]
        ...
        /// <returns>A PDF file rendered as a report containing loan transaction details.</returns>
         ...
         public ActionResult ReportView(string id)
         {
             ...
             {            
                ...
                rptLocation = AppDomain.CurrentDomain.BaseDirectory + @"Files\ReportFiles\WPPF\rptLoanEGCB.rpt";               
