...
namespace SymViewModel.PF
{
    public class PFSettlementVM
    {
        ...
        [Display(Name = "Employee Profit Value")]
        public decimal EmployeeProfitValue { get; set; }
        ...
        [Display(Name = "Settlemen tPolicy")]
        public int SettlementPolicyId { get; set; }
        [Display(Name = "Job Age in Month")]
        ...
        [Display(Name = "Employee Profit Ratio")]
        public decimal EmployeeProfitRatio { get; set; }
        [Display(Name = "Employer Profit Ratio")]
        public decimal EmployerProfitRatio { get; set; }
        ...
        [Display(Name = "Employee Actual Contribution")]
        public decimal EmployeeActualProfitValue { get; set; }
        [Display(Name = "Employer Actual Contribution")]
        public decimal EmployeeActualContribution { get; set; }
        [Display(Name = "Employee Actual Profit Value")]
        public decimal EmployerActualProfitValue { get; set; }
        [Display(Name = "Employer Actual Profit Value")]
        public decimal EmployerActualContribution { get; set; }
