...
{
    public class Schedule1SalaryVM
    {
        ...
        public decimal RebateAmountMonthly { get; set; }
        public decimal RebateAmountYearly { get; set; }
        ...
        public void CalculateTotalRebate()
        {
            decimal taxPaymentYearly = TotalTaxableAmount * 12;
            decimal investmentLimit = taxPaymentYearly * (decimal) (25 / 100.00);
            decimal rebateAmount = 0;

            if (investmentLimit > 15000000)
            {
                investmentLimit = 15000000;
            }

            if (taxPaymentYearly > 1500000)
            {
                rebateAmount = investmentLimit * (decimal) (10 / 100.00);
            }
            else
            {
                rebateAmount = investmentLimit * (decimal) (15 / 100.00);
            }

            RebateAmountMonthly = TotalTaxPayAmount == 0 ? 0 : rebateAmount / 12;

        }

        public decimal OneThird { get; set; }
    }
}
