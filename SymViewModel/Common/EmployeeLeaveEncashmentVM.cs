...
namespace SymViewModel.Common
{
    public class EmployeeLeaveEncashmentVM
    {
        ...
        public decimal EncashmentBalance { get; set; }
        [Display(Name = "Anual Balance")]
        public decimal AnualBalance { get; set; }
        [Display(Name = "Encashment Ratio")]
        public decimal EncashmentRatio { get; set; }
        [Display(Name = "Encashment")]
        public decimal EncashmentTotal { get; set; }
