...
{
    public class EmployeeDependentVM
    {
        [Required]//       [Required(ErrorMessage = "Code is required")]
        ...
        [Display(Name = "Dependent Allowance")]
        public bool IsDependentAllowance { get; set; }
