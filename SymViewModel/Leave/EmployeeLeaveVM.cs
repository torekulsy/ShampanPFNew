...
namespace SymViewModel.Leave
{
    public class EmployeeLeaveVM
    {
        ...
        public IEnumerable<EmployeeLeaveStructureVM> EmployeeLeaveStructures { get; set; }
        public EmployeeLeaveDetailVM employeeLeaveDetailVM { get; set; }
        ...
        public bool IsHolyDayLeaveSkip { get; set; }
