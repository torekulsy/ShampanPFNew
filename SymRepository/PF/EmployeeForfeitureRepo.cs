...
namespace SymRepository.PF
{
    public class EmployeeForfeitureRepo
    {
        ...
        public List<EmployeePFForfeitureVM> SelectAll(string branchId, string empid = null, string[] conditionFields = null, string[] conditionValues = null)
        {
            try
            {
                return new EmployeeForfeitureDAL().SelectAll(branchId, empid, conditionFields, conditionValues);
            }
            catch (Exception ex)
            {
                throw ex;
