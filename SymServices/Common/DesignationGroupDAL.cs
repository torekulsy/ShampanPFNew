...
{
    public class DesignationGroupDAL
    {
        ...
        public List<DesignationGroupVM> SelectAll()
        {
            ...
            string sqlText = "";
            List<DesignationGroupVM> designationGroupVMs = new List<DesignationGroupVM>();
            DesignationGroupVM designationGroupVM;
...
";
                ...
                while (dr.Read())
                {
                    designationGroupVM = new DesignationGroupVM();
                    designationGroupVM.Id = dr["Id"].ToString();
                    designationGroupVM.Serial = Convert.ToInt32(dr["Serial"]);
                    designationGroupVM.BranchId = Convert.ToInt32(dr["BranchId"]);
                    designationGroupVM.Code = dr["Code"].ToString();
                    designationGroupVM.Name = dr["Name"].ToString();
                    designationGroupVM.Remarks = dr["Remarks"].ToString();
                    designationGroupVM.IsActive = Convert.ToBoolean(dr["IsActive"]);
                    designationGroupVM.CreatedAt = Ordinary.StringToDate(dr["CreatedAt"].ToString());
                    designationGroupVM.CreatedBy = dr["CreatedBy"].ToString();
                    designationGroupVM.CreatedFrom = dr["CreatedFrom"].ToString();
                    designationGroupVM.LastUpdateAt = Ordinary.StringToDate(dr["LastUpdateAt"].ToString());
                    designationGroupVM.LastUpdateBy = dr["LastUpdateBy"].ToString();
                    designationGroupVM.LastUpdateFrom = dr["LastUpdateFrom"].ToString();
                    designationGroupVMs.Add(designationGroupVM);
                }
                dr.Close();
                #endregion
            }
        ...
        public DesignationGroupVM SelectById(string Id)
        {
            ...
            SqlConnection currConn = null;
            string sqlText = "";
            DesignationGroupVM designationGroupVM = new DesignationGroupVM();
            #endregion
...
";
            ...
            #endregion
            return designationGroupVM;
        }
        //==================Insert =================
        public string[] Insert(DesignationGroupVM vm, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Initializ
            string sqlText = "";
            int Id = 0;
        ...
        //==================Update =================
        public string[] Update(DesignationGroupVM vm, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "Designation Group Update"; //Method Name
            int transResult = 0;
            string sqlText = "";
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                if (vm != null)
                {
                    ...
                    sqlText = "";
                    sqlText = "update DesignationGroup set";
                ...
                {
                    throw new ArgumentNullException("Designation Group Update", "Could not found any item.");
                }
                ...
                {
                    retResults[1] = "Unexpected error to update Designation Group.";
        ...
        //==================Delete =================
        public string[] Delete(DesignationGroupVM designationGroupVM, string[] ids, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "DeleteDesignationGroup"; //Method Name
            int transResult = 0;
            int countId = 0;
            string sqlText = "";
            SqlConnection currConn = null;
            ...
            try
            {
                ...
                if (ids.Length >= 1)
                {
                    ...
                    for (int i = 0; i < ids.Length - 1; i++)
                    {
                        ...
                        cmdUpdate.Parameters.AddWithValue("@LastUpdateBy", designationGroupVM.LastUpdateBy);
                        cmdUpdate.Parameters.AddWithValue("@LastUpdateAt", designationGroupVM.LastUpdateAt);
                        cmdUpdate.Parameters.AddWithValue("@LastUpdateFrom", designationGroupVM.LastUpdateFrom);
                        cmdUpdate.Transaction = transaction;
                        var exeRes = cmdUpdate.ExecuteNonQuery();
                        transResult = Convert.ToInt32(exeRes);
                    }
                    ...
                    if (transResult <= 0)
                    {
                        throw new ArgumentNullException("Department Delete", designationGroupVM.Id + " could not Delete.");
                    }
                    #endregion Commit
                    #endregion Update Settings
                    iSTransSuccess = true;
...
";
        ...
        public List<string> Autocomplete(string term)
        {
            ...
            try
            {
                ...
                #region sql statement
                sqlText = "";
                sqlText = @"SELECT Id, Name    FROM DesignationGroup ";
...
";
        ...
        public string[] InsertExportData(DesignationGroupVM paramVM, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
            #region Initializ
            string sqlText = "";
            int Id = 0;
            ...
            try
            {
                ...
                DesignationGroupVM vDesignationGroupVM = new DesignationGroupVM();

                #region Assign Data
                int i = 0;
                foreach (DataRow dr in dt.Rows)
                {
                    //vDesignationGroupVM.Id = dr["Id"].ToString();
                    vDesignationGroupVM.BranchId = Convert.ToInt32(dr["BranchId"].ToString());
                    vDesignationGroupVM.Code = dr["Code"].ToString();
                    vDesignationGroupVM.Name = dr["Name"].ToString();                 
                    vDesignationGroupVM.Remarks = dr["Remarks"].ToString();               
                    vDesignationGroupVM.CreatedAt = paramVM.CreatedAt;
                    vDesignationGroupVM.CreatedBy = paramVM.CreatedBy;
                    vDesignationGroupVM.CreatedFrom = paramVM.CreatedFrom;
                    retResults = Insert(vDesignationGroupVM, currConn, transaction);
                }
                #endregion
