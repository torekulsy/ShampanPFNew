...
{
    public class PFBankDepositDetailDAL
    {
        ...
        //==================SelectAll=================
        public List<PFBankDepositDetailVM> SelectById(int Id = 0, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            string sqlText = "";
            List<PFBankDepositDetailVM> VMs = new List<PFBankDepositDetailVM>();
            #endregion
            try
            {
        ...
        public List<PFBankDepositDetailVM> SelectByMasterId(int Id = 0, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                string[] cFields = { "bdd.PFBankDepositId" };
                string[] cValues = { Id.ToString() };
        ...
        public List<PFBankDepositDetailVM> SelectAll(string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
...
SELECT bdd.[Id]
      ...
      ,bdd.[Post]
	  ,acc.AccountType
FROM [dbo].[PFBankDepositDetails] bdd
...
";
                ...
                while (dr.Read())
                {
                    vm = new PFBankDepositDetailVM();
                    vm.PFBankDepositId = Convert.ToInt32(dr["PFBankDepositId"]);
        ...
        //==================Insert =================
        public string[] Insert(List<PFBankDepositDetailVM> VMs, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Initializ
            string sqlText = "";
            int NextId = 0;
            ...
            retResults[5] = "InsertPFBankDepositDetail"; //Method Name
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            int transResult = 0;
            #endregion
            ...
            try
            {
                ...
                NextId = _cDal.NextId("PFBankDepositDetails", currConn, transaction);
                if (VMs != null && VMs.Count > 0)
                {
                    #region SqlText
                    sqlText = "  ";
                    sqlText += @" 
INSERT INTO [dbo].[PFBankDepositDetails] (
[Id]
,[PFBankDepositId]
,[TransactionDate]
,[AccountId]
...
";
                    ...
                    #region SqlExecution
                    foreach (PFBankDepositDetailVM vm in VMs)
                    {

                        SqlCommand cmdInsert = new SqlCommand(sqlText, currConn, transaction);
                        cmdInsert.Parameters.AddWithValue("@Id", NextId);
                        cmdInsert.Parameters.AddWithValue("@PFBankDepositId", vm.PFBankDepositId);
