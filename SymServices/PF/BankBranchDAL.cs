...
namespace SymServices.PF
{
    public class BankBranchDAL
    {
        ...
        /// <summary>
        /// Retrieves the Provident Fund (PF) balance and applicable interest rates for a specific employee
        ...
        public List<BankBranchVM> DropDown(string TransType = "PF", string BranchId = null)
        {
            ...
            string sqlText = "";
            List<BankBranchVM> VMs = new List<BankBranchVM>();
            BankBranchVM vm;
            #endregion
            try
            {
...
";
                ...
                while (dr.Read())
                {
                    ...
                    vm.Name = vm.BankName+"~"+vm.BranchName;
                    VMs.Add(vm);
                }
                dr.Close();
                #endregion
...
";
                ...
                while (dr.Read())
                {
                    vm = new BankBranchVM();
                    vm.Id = Convert.ToInt32(dr["Id"]);
                    vm.BankAccountType = dr["Name"].ToString();
                    VMs.Add(vm);
                }
                dr.Close();
                #endregion
        ...
        /// <summary>
        /// Retrieves a list of bank branches from the database, optionally filtered by ID or additional conditions.
        ...
        /// <returns>A list of <see cref="BankBranchVM"/> representing the bank branches matching the criteria.</returns>

        public List<BankBranchVM> SelectAll(int Id = 0, string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
...
";
                ...
                while (dr.Read())
                {
                    vm = new BankBranchVM();
                    vm.Id = Convert.ToInt32(dr["Id"]);
                    vm.BankId = Convert.ToInt32(dr["BankId"]);
                    vm.BankName = dr["BankName"].ToString();
                    vm.BranchName = dr["BranchName"].ToString();
        ...
        /// <summary>
        /// Inserts a new bank branch record into the database with the provided details from the view model.
        /// Handles optional SQL connection and transaction management for use in broader transactional operations.
        /// </summary>
        /// <param name="vm">The <see cref="BankBranchVM"/> containing the bank branch data to insert.</param>
        ...
        public string[] Insert(BankBranchVM vm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Initializ
            string sqlText = "";
            int Id = 0;
            ...
            retResults[5] = "InsertBankBranch"; //Method Name
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            int transResult = 0;
            #endregion
            ...
            try
            {
                ...
                vm.Id = _cDal.NextId("BankBranchs", currConn, transaction);
                if (vm != null)
                {
                    #region SqlText
                    sqlText = "  ";
                    sqlText += @" 
INSERT INTO BankBranchs(
Id
,BankId
,BranchName
,BranchAddress
...
";
                    ...
                    cmdInsert.Parameters.AddWithValue("@BranchAddress", vm.BranchAddress);
                    cmdInsert.Parameters.AddWithValue("@BankAccountType", vm.BankAccountType);
                    cmdInsert.Parameters.AddWithValue("@BankAccountNo", vm.BankAccountNo);
        ...
        /// <summary>
        /// Updates an existing bank branch record in the database with values from the provided view model.
        /// Handles optional SQL connection and transaction to allow for usage in broader transaction scopes.
        /// </summary>
        /// <param name="vm">The <see cref="BankBranchVM"/> containing the updated bank branch information.</param>
        ...
        public string[] Update(BankBranchVM vm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "BankBranchUpdate"; //Method Name
            int transResult = 0;
            string sqlText = "";
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                if (vm != null)
                {
                    ...
                    #region SqlText
                    sqlText = "";
                    sqlText = "UPDATE BankBranchs SET";

                    sqlText += " BankId=@BankId";
                    sqlText += " , BranchName=@BranchName";
                    sqlText += " , BranchAddress=@BranchAddress";
                    sqlText += " , BankAccountType=@BankAccountType";
                    ...
                    cmdUpdate.Parameters.AddWithValue("@BankId", vm.BankId);
                    cmdUpdate.Parameters.AddWithValue("@BranchName", vm.BranchName);
                    cmdUpdate.Parameters.AddWithValue("@BranchAddress", vm.BranchAddress);
                    cmdUpdate.Parameters.AddWithValue("@BankAccountType", vm.BankAccountType);
                    cmdUpdate.Parameters.AddWithValue("@BankAccountNo", vm.BankAccountNo);
                    ...
                    if (transResult <= 0)
                    {
                        // throw new ArgumentNullException("BankBranch Update", vm.BranchId + " could not updated.");
                    }
                    #endregion Commit
                ...
                {
                    throw new ArgumentNullException("BankBranch Update", "Could not found any item.");
                }
                if (Vtransaction == null && transaction != null)
                {
                    transaction.Commit();
        ...
        /// <summary>
        /// Performs a soft delete (archives) of one or more bank branch records based on the provided IDs.
        ...
        public string[] Delete(BankBranchVM vm, string[] ids, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
            ...
            retResults[3] = "sqlText"; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "DeleteBankBranch"; //Method Name
            int transResult = 0;
            string sqlText = "";
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                if (ids.Length >= 1)
                {
                    ...
                    if (transResult <= 0)
                    {
                        throw new ArgumentNullException("BankBranch Delete", vm.Id + " could not Delete.");
                    }
                    #endregion Commit
                    #endregion Update Settings
                }
                ...
                {
                    throw new ArgumentNullException("BankBranch Information Delete", "Could not found any item.");
                }
                if (Vtransaction == null && transaction != null)
                {
                    transaction.Commit();
