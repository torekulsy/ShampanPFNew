...
namespace SymServices.PF
{
    public class ROIDetailDAL
    {
        ...
        //==================SelectAll=================
        public List<ROIDetailVM> SelectById(int Id = 0, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            string sqlText = "";
            List<ROIDetailVM> VMs = new List<ROIDetailVM>();
            #endregion
            try
            {
        ...
        public List<ROIDetailVM> SelectByMasterId(int Id = 0, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
        ...
        public List<ROIDetailVM> SelectAll(string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
...
SELECT rid.[Id]
      ...
      ,rid.[Post]
	  ,acc.AccountType
FROM [dbo].[ROIDetails] rid
left outer join Accounts acc on rid.AccountId=acc.Id
WHERE  1=1
";
        ...
        //==================Insert =================
        public string[] Insert(List<ROIDetailVM> VMs, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Initializ
            string sqlText = "";
            int NextId = 0;
            ...
            retResults[5] = "InsertROIDetail"; //Method Name
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            int transResult = 0;
            #endregion
            ...
            try
            {
                ...
                NextId = _cDal.NextId("ROIDetails", currConn, transaction);
                if (VMs != null && VMs.Count > 0)
                {
                    #region SqlText
                    sqlText = "  ";
                    sqlText += @" 
INSERT INTO [dbo].[ROIDetails] (
[Id]
,[ROIId]
,[TransactionDate]
,[AccountId]
