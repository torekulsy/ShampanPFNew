...
{
    public class InvestmentDetailDAL
    {
        ...
        //==================SelectAll=================
        public List<InvestmentDetailVM> SelectById(int Id = 0, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            string sqlText = "";
            List<InvestmentDetailVM> VMs = new List<InvestmentDetailVM>();
            #endregion
            try
            {
        ...
        public List<InvestmentDetailVM> SelectByMasterId(int Id = 0, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            ...
            try
            {
                ...
                string[] cFields = { "idd.InvestmentId" };
                string[] cValues = { Id.ToString() };
        ...
        public List<InvestmentDetailVM> SelectAll(string[] conditionFields = null, string[] conditionValues = null, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Variables
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
...
SELECT idd.[Id]
      ...
      ,idd.[Post]
	  ,acc.AccountType
FROM [dbo].[InvestmentDetails] idd
left outer join Accounts acc on idd.AccountId=acc.Id
WHERE  1=1
";
        ...
        //==================Insert =================
        public string[] Insert(List<InvestmentDetailVM> VMs, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            #region Initializ
            string sqlText = "";
            int NextId = 0;
            ...
            retResults[5] = "InsertInvestmentDetail"; //Method Name
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            int transResult = 0;
            #endregion
            ...
            try
            {
                ...
                NextId = _cDal.NextId("InvestmentDetails", currConn, transaction);
...
";
                    ...
                    #region SqlExecution
                    foreach (InvestmentDetailVM vm in VMs)
                    {
