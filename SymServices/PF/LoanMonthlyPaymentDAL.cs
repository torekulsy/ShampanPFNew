...
namespace SymServices.PF
{
    public class LoanMonthlyPaymentDAL
    {
        ...
        //==================SelectAll=================
        /// <summary>
        /// Retrieves a list of PF Loan Monthly Payment from the database, optionally filtered by ID or additional conditions.
        /// Supports external SQL connection and transaction handling for reuse within larger operations.
        /// </summary>
        /// <param name="Id">Optional ID to filter a specific PF Loan Monthly Payment.</param>
        ...
        /// <returns>A list of <see cref="BankBranchVM"/> representing the PF Loan Monthly Payment matching the criteria.</returns>
...
";
        ...
        //==================Insert =================
        // <summary>
        /// Inserts a new PF Loan Monthly Paymen record into the database with the provided details from the view model.
        /// Handles optional SQL connection and transaction management for use in broader transactional operations.
        /// </summary>
        /// <param name="vm">The <see cref="BankBranchVM"/> containing the PF Loan Monthly Paymen data to insert.</param>
...
";
        ...
        //==================Update =================
        /// <summary>
        /// Updates an existing PF Loan record Monthly Paymen in the database with values from the provided view model.
        /// Handles optional SQL connection and transaction to allow for usage in broader transaction scopes.
        /// </summary>
        /// <param name="vm">The <see cref="BankBranchVM"/> containing the updated PF Loan Monthly Paymen information.</param>
