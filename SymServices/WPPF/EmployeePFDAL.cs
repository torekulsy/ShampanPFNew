...
";
        ...
        ////==================ExportExcelFile =================
        /// <summary>
        /// Retrieves and returns a DataTable containing employee provident fund (WPPF) details,
        /// including employee information and WPPF structure data, for active and non-archived employees.
        /// Optionally supports filtering with condition fields and values (currently commented out).
        /// </summary>
        /// <param name="vm">An EmployeePFVM object representing the employee WPPF view model (not used in current implementation).</param>
        ...
        /// <returns>
        /// A DataTable containing employee WPPF information merged from EmployeePF and ViewEmployeeInformation tables,
        /// with additional joined data from PFStructure and an added "Type" column set as "Employee WPPF".
        /// Throws an ArgumentNullException if no employee WPPF records are found.
        /// </returns>
...
";
                ...
                if (dt.Rows.Count == 0)
                {
                    throw new ArgumentNullException("Employee WPPF has not given to any employee!");
                }
                foreach (DataRow row in dt.Rows)
                {
                    row["Type"] = "Employee WPPF";
                }
                #endregion
            }
            catch (Exception ex)
        ...
        ////==================ImportExcelFile =================
        /// <summary>
        /// Imports employee provident fund (WPPF) data from an Excel file and saves it to the database.
        ...
        public string[] ImportExcelFile(string fullPath, string fileName, ShampanIdentityVM auditvm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        {
            ...
            retResults[3] = sqlText; //  SQL Query
            retResults[4] = "ex"; //catch ex
            retResults[5] = "Employee WPPF"; //Method Name
            SqlConnection currConn = null;
            SqlTransaction transaction = null;
            #endregion
            #region try
