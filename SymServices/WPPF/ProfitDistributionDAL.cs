...
";
                sqlText = sqlText + @" LEFT OUTER JOIN FiscalYearDetail fydFrom ON pd.FiscalYearDetailId=fydFrom.Id";
                sqlText = sqlText + @" LEFT OUTER JOIN FiscalYearDetail fydTo ON pd.FiscalYearDetailIdTo=fydTo.Id";
